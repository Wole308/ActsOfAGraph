...
o_path0="debugger/kernel_debugger.cpp"
o_path1="src/common.h"
o_path2="debugger/kernel_debugger.cpp"
o_path3="debugger/kernel_debugger.h"
o_path4="debugger/kernel_debugger.cpp"
o_path5="debugger/kernel_debugger.cpp"
o_path6="debugger/kernel_debugger.cpp"
o_path7="src/host_functions.cpp"
o_path8="debugger/host_debugger.cpp"
o_path9="debugger/kernel_debugger.cpp"
o_path10="debugger/kernel_debugger.cpp"
o_path11="kernels/titan.cpp"
o_path12="kernels/titan.h"
o_path13="debugger/kernel_debugger.cpp"
o_path14="debugger/kernel_debugger.cpp"
o_path15="src/hostprocess.cpp"
o_path16="debugger/kernel_debugger.cpp"
o_path17="debugger/kernel_debugger.cpp"
...
o_path39="kernels/legion.cpp"
o_path40="kernels/legion.h"
o_path41="src/host_legion.cpp"
o_path42="src/host_legion.h"
o_path43="kernels/enigma.cpp"
o_path44="kernels/enigma.h"
o_path45="src/host_enigma.cpp"
o_path46="src/host_enigma.h"
o_path47="kernels/titan.cpp"
o_path48="kernels/titan.h"
o_path49="src/host_titan.cpp"
o_path50="src/host_titan.h"
o_path51="kernels/kernelprocess.cpp"
o_path52="kernels/kernelprocess.h"
o_path53="src/host_kernelprocess.cpp"
o_path54="src/host_kernelprocess.h"
...
templ_path0="templates/debugger/"
templ_path1="templates/src/"
templ_path2="templates/debugger/"
templ_path3="templates/debugger/"
templ_path4="templates/debugger/"
templ_path5="templates/debugger/"
templ_path6="templates/debugger/"
templ_path7="templates/src/"
templ_path8="templates/debugger/"
templ_path9="templates/debugger/"
templ_path10="templates/debugger/"
templ_path11="templates/kernels/"
templ_path12="templates/kernels/"
templ_path13="templates/debugger/"
templ_path14="templates/debugger/"
templ_path15="templates/src/"
templ_path16="templates/debugger/"
templ_path17="templates/debugger/"
...
templ_path39="templates/kernels/"
templ_path40="templates/kernels/"
...
template0 = env0.get_template('kernel_debugger.template')
template1 = env1.get_template('common_h.template')
template2 = env2.get_template('kernel_debugger.template')
template3 = env3.get_template('kernel_debugger_h.template')
template4 = env4.get_template('kernel_debugger.template')
template5 = env5.get_template('kernel_debugger.template')
template6 = env6.get_template('kernel_debugger.template')
template7 = env7.get_template('host_functions.template')
template8 = env8.get_template('host_debugger.template')
template9 = env9.get_template('kernel_debugger.template')
template10 = env10.get_template('kernel_debugger.template')
template11 = env11.get_template('titan.template')
template12 = env12.get_template('kernelprocess_h.template')
template13 = env13.get_template('kernel_debugger.template')
template14 = env14.get_template('kernel_debugger.template')
template15 = env15.get_template('hostprocess.template')
template16 = env16.get_template('kernel_debugger.template')
template17 = env17.get_template('kernel_debugger.template')
...
template39 = env39.get_template('legion.template')
template40 = env40.get_template('legion_h.template')
template41 = env41.get_template('host_legion.template')
template42 = env42.get_template('host_legion_h.template')
...
template47 = env47.get_template('titan.template')
template48 = env48.get_template('titan_h.template')
template49 = env49.get_template('host_titan.template')
template50 = env50.get_template('host_titan_h.template')
template51 = env51.get_template('kernelprocess.template')
template52 = env52.get_template('kernelprocess_h.template')
template53 = env53.get_template('host_kernelprocess.template')
template54 = env54.get_template('host_kernelprocess_h.template')
