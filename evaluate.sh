	...
	do 
		...
		do
			...
			do
				...
				for dataset in $ORKUT_3M_212M $HOLLYWOOD_1M_114M $KRON21_2M_91M $RGG_N_2_24_S0_16M_265M $EUROPE_OSM_50M_108M $KMER_V2A_55M_117M $HUGEBUBBLES_00020_21M_63M $RMAT24_268M $RMAT25_268M $RMAT26_268M $RMAT24_380M $RMAT25_380M $RMAT26_380M	
				do
