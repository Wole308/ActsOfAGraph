...
#define MY_IFDEF_UPDATESTMPBUFFER() keyvalue_t updates_buffer2[EDGE_PACK_SIZE][UPDATES_BUFFER_SIZE]	
...
#define MY_IFDEF_TOPLEVELFUNC() void top_function( HBM_channelTHIS_t * HBM_channelA0, HBM_channelTHIS_t * HBM_channelB0, HBM_channelTHIS_t * HBM_channelA1, HBM_channelTHIS_t * HBM_channelB1, HBM_channelTHIS_t * HBM_channelA2, HBM_channelTHIS_t * HBM_channelB2, HBM_channelTHIS_t * HBM_channelA3, HBM_channelTHIS_t * HBM_channelB3, HBM_channelTHIS_t * HBM_channelA4, HBM_channelTHIS_t * HBM_channelB4, HBM_channelTHIS_t * HBM_channelA5, HBM_channelTHIS_t * HBM_channelB5, HBM_channelTHIS_t * HBM_centerA, HBM_channelTHIS_t * HBM_centerB)
#else
...
#define MY_IFDEF_UPDATESTMPBUFFER() keyvalue_t * updates_buffer2[EDGE_PACK_SIZE]
...
#define MY_IFDEF_TOPLEVELFUNC() void acts_kernel::top_function( HBM_channelTHIS_t * HBM_channelA0, HBM_channelTHIS_t * HBM_channelB0, HBM_channelTHIS_t * HBM_channelA1, HBM_channelTHIS_t * HBM_channelB1, HBM_channelTHIS_t * HBM_channelA2, HBM_channelTHIS_t * HBM_channelB2, HBM_channelTHIS_t * HBM_channelA3, HBM_channelTHIS_t * HBM_channelB3, HBM_channelTHIS_t * HBM_channelA4, HBM_channelTHIS_t * HBM_channelB4, HBM_channelTHIS_t * HBM_channelA5, HBM_channelTHIS_t * HBM_channelB5, HBM_channelTHIS_t * HBM_centerA, HBM_channelTHIS_t * HBM_centerB)
#endif
...
//////////////////////////////////////////////////////////////////
void master_centerinsert_vec(unsigned int offset, unsigned int data[HBM_CHANNEL_PACK_SIZE], HBM_channelTHIS_t * HBM_centerA, HBM_channelTHIS_t * HBM_centerB){
	// #pragma HLS INLINE
	#ifdef FPGA_IMPL 
...
void master_centerretrieve_vec(unsigned int offset, unsigned int data[HBM_CHANNEL_PACK_SIZE], HBM_channelTHIS_t * HBM_centerA, HBM_channelTHIS_t * HBM_centerB){
	// #pragma HLS INLINE
	#ifdef FPGA_IMPL 
...
void master_insertmany_vec(unsigned int offsets[VALID_NUMPEs], bool ens[VALID_NUMPEs], unsigned int data[VALID_NUMPEs][HBM_CHANNEL_PACK_SIZE],  HBM_channelTHIS_t * HBM_channelA0, HBM_channelTHIS_t * HBM_channelB0, HBM_channelTHIS_t * HBM_channelA1, HBM_channelTHIS_t * HBM_channelB1, HBM_channelTHIS_t * HBM_channelA2, HBM_channelTHIS_t * HBM_channelB2, HBM_channelTHIS_t * HBM_channelA3, HBM_channelTHIS_t * HBM_channelB3, HBM_channelTHIS_t * HBM_channelA4, HBM_channelTHIS_t * HBM_channelB4, HBM_channelTHIS_t * HBM_channelA5, HBM_channelTHIS_t * HBM_channelB5){
	// #pragma HLS INLINE
	#ifdef FPGA_IMPL 
		#ifndef RESOLVE_VHLS_TIMING
		if(ens[0]==true){
		#endif 
...
void master_retrievemany(unsigned int offsets[VALID_NUMPEs], unsigned int v, unsigned int data[VALID_NUMPEs],  HBM_channelTHIS_t * HBM_channelA0, HBM_channelTHIS_t * HBM_channelB0, HBM_channelTHIS_t * HBM_channelA1, HBM_channelTHIS_t * HBM_channelB1, HBM_channelTHIS_t * HBM_channelA2, HBM_channelTHIS_t * HBM_channelB2, HBM_channelTHIS_t * HBM_channelA3, HBM_channelTHIS_t * HBM_channelB3, HBM_channelTHIS_t * HBM_channelA4, HBM_channelTHIS_t * HBM_channelB4, HBM_channelTHIS_t * HBM_channelA5, HBM_channelTHIS_t * HBM_channelB5){
	// #pragma HLS INLINE
...
//////////////////////////////////////////////////////////////////
void insert_cfrontierdram(unsigned int p_u, unsigned int t, keyvalue_t data[EDGE_PACK_SIZE], HBM_channelTHIS_t * HBM_centerA, HBM_channelTHIS_t * HBM_centerB){
	#pragma HLS INLINE
...
void retrieve_cfrontierdram(unsigned int p_u, unsigned int t, keyvalue_t data[EDGE_PACK_SIZE], HBM_channelTHIS_t * HBM_centerA, HBM_channelTHIS_t * HBM_centerB){
	#pragma HLS INLINE
	unsigned int data_[HBM_CHANNEL_PACK_SIZE];
	#pragma HLS ARRAY_PARTITION variable=data_ complete
	master_centerretrieve_vec(t, data_, HBM_centerA, HBM_centerB); // CRITICAL REMOVEME.
	for(unsigned int v=0; v<EDGE_PACK_SIZE; v++){
	#pragma HLS UNROLL
...
void dretrievemany_vptrdram(unsigned int base_offset__, unsigned int offsets[VALID_NUMPEs], unsigned int data[VALID_NUMPEs],  HBM_channelTHIS_t * HBM_channelA0, HBM_channelTHIS_t * HBM_channelB0, HBM_channelTHIS_t * HBM_channelA1, HBM_channelTHIS_t * HBM_channelB1, HBM_channelTHIS_t * HBM_channelA2, HBM_channelTHIS_t * HBM_channelB2, HBM_channelTHIS_t * HBM_channelA3, HBM_channelTHIS_t * HBM_channelB3, HBM_channelTHIS_t * HBM_channelA4, HBM_channelTHIS_t * HBM_channelB4, HBM_channelTHIS_t * HBM_channelA5, HBM_channelTHIS_t * HBM_channelB5){
...
void dretrievemany_actpackvptrdram(unsigned int base_offset__, unsigned int p_u, unsigned int llp_set, map_t maps[VALID_NUMPEs],  HBM_channelTHIS_t * HBM_channelA0, HBM_channelTHIS_t * HBM_channelB0, HBM_channelTHIS_t * HBM_channelA1, HBM_channelTHIS_t * HBM_channelB1, HBM_channelTHIS_t * HBM_channelA2, HBM_channelTHIS_t * HBM_channelB2, HBM_channelTHIS_t * HBM_channelA3, HBM_channelTHIS_t * HBM_channelB3, HBM_channelTHIS_t * HBM_channelA4, HBM_channelTHIS_t * HBM_channelB4, HBM_channelTHIS_t * HBM_channelA5, HBM_channelTHIS_t * HBM_channelB5){
	unsigned int offset = ((p_u * MAX_NUM_LLPSETS) + llp_set) * 2; // FIXME.
	#ifdef _DEBUGMODE_CHECKS3
	unsigned int wwsize = globalparams_debug[GLOBALPARAMSCODE__WWSIZE__ACTPACKVPTRS];
	checkoutofbounds("acts_kernel::ERROR 702::", offset / HBM_CHANNEL_PACK_SIZE, wwsize, NAp, NAp, NAp);
...
edge3_vec_dt dretrieve_csredges(unsigned int base_offset__, unsigned int index, HBM_channelTHIS_t * HBM_channelA, HBM_channelTHIS_t * HBM_channelB, unsigned int inst){
...
void dretrievemany_act_pack_edges(unsigned int base_offset__, unsigned int offsets[VALID_NUMPEs], unsigned int t, edge3_vec_dt edge3_vecs[VALID_NUMPEs],  HBM_channelTHIS_t * HBM_channelA0, HBM_channelTHIS_t * HBM_channelB0, HBM_channelTHIS_t * HBM_channelA1, HBM_channelTHIS_t * HBM_channelB1, HBM_channelTHIS_t * HBM_channelA2, HBM_channelTHIS_t * HBM_channelB2, HBM_channelTHIS_t * HBM_channelA3, HBM_channelTHIS_t * HBM_channelB3, HBM_channelTHIS_t * HBM_channelA4, HBM_channelTHIS_t * HBM_channelB4, HBM_channelTHIS_t * HBM_channelA5, HBM_channelTHIS_t * HBM_channelB5){
	#ifdef _DEBUGMODE_CHECKS3
...
void dretrievemany_actpackedges(unsigned int base_offset__, unsigned int offsets[VALID_NUMPEs], unsigned int t, uint512_vec_dt data[VALID_NUMPEs],  HBM_channelTHIS_t * HBM_channelA0, HBM_channelTHIS_t * HBM_channelB0, HBM_channelTHIS_t * HBM_channelA1, HBM_channelTHIS_t * HBM_channelB1, HBM_channelTHIS_t * HBM_channelA2, HBM_channelTHIS_t * HBM_channelB2, HBM_channelTHIS_t * HBM_channelA3, HBM_channelTHIS_t * HBM_channelB3, HBM_channelTHIS_t * HBM_channelA4, HBM_channelTHIS_t * HBM_channelB4, HBM_channelTHIS_t * HBM_channelA5, HBM_channelTHIS_t * HBM_channelB5){
	#ifdef _DEBUGMODE_CHECKS3
	unsigned int wwsize = globalparams_debug[GLOBALPARAMSCODE__WWSIZE__ACTPACKEDGES];
	checkoutofbounds("acts_kernel::ERROR 704f::", offsets[0] + t, wwsize, NAp, NAp, NAp);
	#endif 
...
void dinsertmany_updatesdram(unsigned int offset__, unsigned int llp_set, unsigned int offsets[VALID_NUMPEs], unsigned int t, uint512_vec_dt data[VALID_NUMPEs], bool ens[VALID_NUMPEs][EDGE_PACK_SIZE],  HBM_channelTHIS_t * HBM_channelA0, HBM_channelTHIS_t * HBM_channelB0, HBM_channelTHIS_t * HBM_channelA1, HBM_channelTHIS_t * HBM_channelB1, HBM_channelTHIS_t * HBM_channelA2, HBM_channelTHIS_t * HBM_channelB2, HBM_channelTHIS_t * HBM_channelA3, HBM_channelTHIS_t * HBM_channelB3, HBM_channelTHIS_t * HBM_channelA4, HBM_channelTHIS_t * HBM_channelB4, HBM_channelTHIS_t * HBM_channelA5, HBM_channelTHIS_t * HBM_channelB5, unsigned int updatesptrs[MAX_NUM_LLPSETS]){
	#ifdef _DEBUGMODE_CHECKS3
	unsigned int wwsize = globalparams_debug[GLOBALPARAMSCODE__WWSIZE__UPDATES];
	...
	#pragma HLS UNROLL
		...
		offsets_[n] = offsets[n]; // CRITICAL REMOVEME.
	}
	for(unsigned int n=0; n<VALID_NUMPEs; n++){
	#pragma HLS UNROLL
		ens_[n] = ens[n][0];
...
void dretrievemany_udatesdram(unsigned int offset__, unsigned int llp_set, unsigned int index, uint512_vec_dt data[VALID_NUMPEs],  HBM_channelTHIS_t * HBM_channelA0, HBM_channelTHIS_t * HBM_channelB0, HBM_channelTHIS_t * HBM_channelA1, HBM_channelTHIS_t * HBM_channelB1, HBM_channelTHIS_t * HBM_channelA2, HBM_channelTHIS_t * HBM_channelB2, HBM_channelTHIS_t * HBM_channelA3, HBM_channelTHIS_t * HBM_channelB3, HBM_channelTHIS_t * HBM_channelA4, HBM_channelTHIS_t * HBM_channelB4, HBM_channelTHIS_t * HBM_channelA5, HBM_channelTHIS_t * HBM_channelB5, unsigned int updatesptrs[MAX_NUM_LLPSETS]){
	#ifdef _DEBUGMODE_CHECKS3
	unsigned int wwsize = globalparams_debug[GLOBALPARAMSCODE__WWSIZE__UPDATES];
	checkoutofbounds("acts_kernel::ERROR 710a::", updatesptrs[llp_set] + index, updatesptrs[llp_set + 1], NAp, NAp, NAp);
	#endif 
...
void dinsertmany_vdatadram(unsigned int offset__, unsigned int offsets[VALID_NUMPEs], unsigned int t, vprop_t datas[VALID_NUMPEs][EDGE_PACK_SIZE],  HBM_channelTHIS_t * HBM_channelA0, HBM_channelTHIS_t * HBM_channelB0, HBM_channelTHIS_t * HBM_channelA1, HBM_channelTHIS_t * HBM_channelB1, HBM_channelTHIS_t * HBM_channelA2, HBM_channelTHIS_t * HBM_channelB2, HBM_channelTHIS_t * HBM_channelA3, HBM_channelTHIS_t * HBM_channelB3, HBM_channelTHIS_t * HBM_channelA4, HBM_channelTHIS_t * HBM_channelB4, HBM_channelTHIS_t * HBM_channelA5, HBM_channelTHIS_t * HBM_channelB5){
	#ifdef _DEBUGMODE_CHECKS3
	unsigned int wwsize = globalparams_debug[GLOBALPARAMSCODE__WWSIZE__VDATAS];
	...
	#pragma HLS UNROLL
		// offsets_[n] = offset__ + offsets[n] + t;
		offsets_[n] = offsets[n]; // offset__ + offsets[n] + t; // CRITICAL REMOVEME
	}
	for(unsigned int n=0; n<VALID_NUMPEs; n++){
	#pragma HLS UNROLL
		ens_[n] = true;
	}
	for(unsigned int n=0; n<VALID_NUMPEs; n++){ // CRITICAL NEWCHANGE
	#pragma HLS UNROLL
		for(unsigned int v=0; v<EDGE_PACK_SIZE; v++){
		#pragma HLS UNROLL
...
void dretrievemany_vdatadram(unsigned int offset__, unsigned int offsets[VALID_NUMPEs], unsigned int t, vprop_t datas[VALID_NUMPEs][EDGE_PACK_SIZE],  HBM_channelTHIS_t * HBM_channelA0, HBM_channelTHIS_t * HBM_channelB0, HBM_channelTHIS_t * HBM_channelA1, HBM_channelTHIS_t * HBM_channelB1, HBM_channelTHIS_t * HBM_channelA2, HBM_channelTHIS_t * HBM_channelB2, HBM_channelTHIS_t * HBM_channelA3, HBM_channelTHIS_t * HBM_channelB3, HBM_channelTHIS_t * HBM_channelA4, HBM_channelTHIS_t * HBM_channelB4, HBM_channelTHIS_t * HBM_channelA5, HBM_channelTHIS_t * HBM_channelB5){
	#ifdef _DEBUGMODE_CHECKS3
	unsigned int wwsize = globalparams_debug[GLOBALPARAMSCODE__WWSIZE__VDATAS];
...
void dinsertmany_cfrontierdram_tmp(unsigned int base_offset__, unsigned int offsets[VALID_NUMPEs], unsigned int t, keyvalue_t datas[VALID_NUMPEs][EDGE_PACK_SIZE], bool ens[VALID_NUMPEs][EDGE_PACK_SIZE],  HBM_channelTHIS_t * HBM_channelA0, HBM_channelTHIS_t * HBM_channelB0, HBM_channelTHIS_t * HBM_channelA1, HBM_channelTHIS_t * HBM_channelB1, HBM_channelTHIS_t * HBM_channelA2, HBM_channelTHIS_t * HBM_channelB2, HBM_channelTHIS_t * HBM_channelA3, HBM_channelTHIS_t * HBM_channelB3, HBM_channelTHIS_t * HBM_channelA4, HBM_channelTHIS_t * HBM_channelB4, HBM_channelTHIS_t * HBM_channelA5, HBM_channelTHIS_t * HBM_channelB5){
	#ifdef _DEBUGMODE_CHECKS3
	unsigned int wwsize = globalparams_debug[GLOBALPARAMSCODE__WWSIZE__CFRONTIERSTMP];
	checkoutofbounds("acts_kernel::ERROR 713a::", offsets[0], globalparams_debug[GLOBALPARAMSCODE__BASEOFFSET__NFRONTIERS], NAp, NAp, NAp);
	#endif 
	...
	#pragma HLS UNROLL
		// offsets_[n] = base_offset__ + offsets[n] + t;
		offsets_[n] = offsets[n]; // CRITICAL NEWCHANGE
	}
	for(unsigned int n=0; n<VALID_NUMPEs; n++){
	#pragma HLS UNROLL
		ens_[n] = ens[n][0];
...
void dretrievemany_cfrontierdram_tmp(unsigned int base_offset__, unsigned int offsets[VALID_NUMPEs], unsigned int t, keyvalue_t datas[VALID_NUMPEs][EDGE_PACK_SIZE],  HBM_channelTHIS_t * HBM_channelA0, HBM_channelTHIS_t * HBM_channelB0, HBM_channelTHIS_t * HBM_channelA1, HBM_channelTHIS_t * HBM_channelB1, HBM_channelTHIS_t * HBM_channelA2, HBM_channelTHIS_t * HBM_channelB2, HBM_channelTHIS_t * HBM_channelA3, HBM_channelTHIS_t * HBM_channelB3, HBM_channelTHIS_t * HBM_channelA4, HBM_channelTHIS_t * HBM_channelB4, HBM_channelTHIS_t * HBM_channelA5, HBM_channelTHIS_t * HBM_channelB5){
	#ifdef _DEBUGMODE_CHECKS3
	unsigned int wwsize = globalparams_debug[GLOBALPARAMSCODE__WWSIZE__CFRONTIERSTMP];
...
void dinsertmany_nfrontierdram(unsigned int offset__, unsigned int p_u, unsigned int offsets[VALID_NUMPEs], unsigned int t, keyvalue_t datas[VALID_NUMPEs][EDGE_PACK_SIZE], bool ens[VALID_NUMPEs][EDGE_PACK_SIZE],  HBM_channelTHIS_t * HBM_channelA0, HBM_channelTHIS_t * HBM_channelB0, HBM_channelTHIS_t * HBM_channelA1, HBM_channelTHIS_t * HBM_channelB1, HBM_channelTHIS_t * HBM_channelA2, HBM_channelTHIS_t * HBM_channelB2, HBM_channelTHIS_t * HBM_channelA3, HBM_channelTHIS_t * HBM_channelB3, HBM_channelTHIS_t * HBM_channelA4, HBM_channelTHIS_t * HBM_channelB4, HBM_channelTHIS_t * HBM_channelA5, HBM_channelTHIS_t * HBM_channelB5){
	unsigned int data_[VALID_NUMPEs][HBM_CHANNEL_PACK_SIZE];
	#pragma HLS ARRAY_PARTITION variable=data_ complete dim=0
	unsigned int offsets_[VALID_NUMPEs];
	#pragma HLS ARRAY_PARTITION variable=offsets_ complete
...
void retrieveandresetvec_vdatabuffer(unsigned int index, vprop_t data[EDGE_PACK_SIZE], MY_IFDEF_VDATABUFFER()){
	...
	#pragma HLS UNROLL
		...
		data[v].prop = vdata_buffer[v][index >> POW_VALID_VDATA].prop; // CRITICAL NEWCHANGE
...
void transport_frontier(unsigned int inst, unsigned int p_v, unsigned int baseoffset_nfdram, unsigned int * cfrontier_dram___size, unsigned int * nfrontier_dram___size, offset_t * upartition_vertices, HBM_channelTHIS_t * HBM_channelA, HBM_channelTHIS_t * HBM_channelB, HBM_channelTHIS_t * HBM_centerA, HBM_channelTHIS_t * HBM_centerB, unsigned int * totalactvvs2){
	...
	TRANSPORT_FRONTIER_PROPERTIES_LOOP1: for(unsigned int p_actvv=0; p_actvv<NUM_ACTVVPARTITIONS_PER_APPLYPARTITION; p_actvv++){
		...
		#pragma HLS PIPELINE II=1
			...
			#ifdef rrrrrrrrrrrrrrrrrrrrrr
			dretrieve_nfrontierdram(offset_n, p_actvv_, t, actvv, HBM_channelA, HBM_channelB, inst);
			...
			#endif 
			// insert_cfrontierdram(p_actvv_, offset_c + cfrontier_dram___size[p_actvv_], actvv, HBM_centerA, HBM_centerB); cfrontier_dram___size[p_actvv_] += 1;
			insert_cfrontierdram(p_actvv_, offset_c + st + t, actvv, HBM_centerA, HBM_centerB); //cfrontier_dram___size[p_actvv_] += 1;
			#endif 
			
			// #ifdef ssssssssssssssssssssss
			////////////////////////////////////////////////////////////////////////////////////////////////////////
			#ifdef FPGA_IMPL 
...
#pragma HLS INTERFACE s_axilite port=return bundle=control
	...
	keyvalue_t updates_buffer2[VALID_NUMPEs][EDGE_PACK_SIZE][UPDATES_BUFFER_SIZE];
	...
	#pragma HLS resource variable=vdata_buffer core=XPM_MEMORY uram // CRITICAL REMOVEME.
	...
	#pragma HLS aggregate variable=vdata_buffer // NEW** // CRITICAL REMOVEME.
	#else 
	...
	keyvalue_t * updates_buffer2[VALID_NUMPEs][EDGE_PACK_SIZE]; 
	...
	for(unsigned int i=0; i<VALID_NUMPEs; i++){ for(unsigned int v=0; v<EDGE_PACK_SIZE; v++){ updates_buffer2[i][v] = new keyvalue_t[UPDATES_BUFFER_SIZE]; }}
	...
	// cfrontier_dram___size[0] = 1; // activate root vid
	...
	#pragma HLS PIPELINE II=1
		...
		#pragma HLS UNROLL
			...
			#pragma HLS UNROLL
				// checkoutofbounds("acts_kernel::ERROR 111202-c::", t, MAX_UPARTITION_VECSIZE, NAp, NAp, NAp);
		...
		PROCESS_EDGES_MODULE_LOOP1: for(unsigned int n=0; n<2; n++){
			...
			PROCESS_EDGES_MODULE_LOOP1B: for(unsigned int p_u=0; p_u<__NUM_UPARTITIONS; p_u++){
				...
				#pragma HLS PIPELINE II=1
					...
					HBM_channelA1[offset_c + t].range(95, 64) = data[2];
					HBM_channelA1[offset_c + t].range(127, 96) = data[3];
					HBM_channelA1[offset_c + t].range(159, 128) = data[4];
					HBM_channelA1[offset_c + t].range(191, 160) = data[5];
					HBM_channelA1[offset_c + t].range(223, 192) = data[6];
					HBM_channelA1[offset_c + t].range(255, 224) = data[7];
					HBM_channelA1[offset_c + t].range(287, 256) = data[8];
					HBM_channelA1[offset_c + t].range(319, 288) = data[9];
					HBM_channelA1[offset_c + t].range(351, 320) = data[10];
					HBM_channelA1[offset_c + t].range(383, 352) = data[11];
					HBM_channelA1[offset_c + t].range(415, 384) = data[12];
					HBM_channelA1[offset_c + t].range(447, 416) = data[13];
					HBM_channelA1[offset_c + t].range(479, 448) = data[14];
					HBM_channelA1[offset_c + t].range(511, 480) = data[15];
					HBM_channelB1[offset_c + t].range(31, 0) = data[16];
					HBM_channelB1[offset_c + t].range(63, 32) = data[17];
					HBM_channelB1[offset_c + t].range(95, 64) = data[18];
					HBM_channelB1[offset_c + t].range(127, 96) = data[19];
					HBM_channelB1[offset_c + t].range(159, 128) = data[20];
					HBM_channelB1[offset_c + t].range(191, 160) = data[21];
					HBM_channelB1[offset_c + t].range(223, 192) = data[22];
					HBM_channelB1[offset_c + t].range(255, 224) = data[23];
					HBM_channelB1[offset_c + t].range(287, 256) = data[24];
					HBM_channelB1[offset_c + t].range(319, 288) = data[25];
					HBM_channelB1[offset_c + t].range(351, 320) = data[26];
					HBM_channelB1[offset_c + t].range(383, 352) = data[27];
					HBM_channelB1[offset_c + t].range(415, 384) = data[28];
					HBM_channelB1[offset_c + t].range(447, 416) = data[29];
					HBM_channelB1[offset_c + t].range(479, 448) = data[30];
					HBM_channelB1[offset_c + t].range(511, 480) = data[31];
					HBM_channelA2[offset_c + t].range(31, 0) = data[0];
					HBM_channelA2[offset_c + t].range(63, 32) = data[1];
					HBM_channelA2[offset_c + t].range(95, 64) = data[2];
					HBM_channelA2[offset_c + t].range(127, 96) = data[3];
					HBM_channelA2[offset_c + t].range(159, 128) = data[4];
					HBM_channelA2[offset_c + t].range(191, 160) = data[5];
					HBM_channelA2[offset_c + t].range(223, 192) = data[6];
					HBM_channelA2[offset_c + t].range(255, 224) = data[7];
					HBM_channelA2[offset_c + t].range(287, 256) = data[8];
					HBM_channelA2[offset_c + t].range(319, 288) = data[9];
					HBM_channelA2[offset_c + t].range(351, 320) = data[10];
					HBM_channelA2[offset_c + t].range(383, 352) = data[11];
					HBM_channelA2[offset_c + t].range(415, 384) = data[12];
					HBM_channelA2[offset_c + t].range(447, 416) = data[13];
					HBM_channelA2[offset_c + t].range(479, 448) = data[14];
					HBM_channelA2[offset_c + t].range(511, 480) = data[15];
					HBM_channelB2[offset_c + t].range(31, 0) = data[16];
					HBM_channelB2[offset_c + t].range(63, 32) = data[17];
					HBM_channelB2[offset_c + t].range(95, 64) = data[18];
					HBM_channelB2[offset_c + t].range(127, 96) = data[19];
					HBM_channelB2[offset_c + t].range(159, 128) = data[20];
					HBM_channelB2[offset_c + t].range(191, 160) = data[21];
					HBM_channelB2[offset_c + t].range(223, 192) = data[22];
					HBM_channelB2[offset_c + t].range(255, 224) = data[23];
					HBM_channelB2[offset_c + t].range(287, 256) = data[24];
					HBM_channelB2[offset_c + t].range(319, 288) = data[25];
					HBM_channelB2[offset_c + t].range(351, 320) = data[26];
					HBM_channelB2[offset_c + t].range(383, 352) = data[27];
					HBM_channelB2[offset_c + t].range(415, 384) = data[28];
					HBM_channelB2[offset_c + t].range(447, 416) = data[29];
					HBM_channelB2[offset_c + t].range(479, 448) = data[30];
					HBM_channelB2[offset_c + t].range(511, 480) = data[31];
					HBM_channelA3[offset_c + t].range(31, 0) = data[0];
					HBM_channelA3[offset_c + t].range(63, 32) = data[1];
					HBM_channelA3[offset_c + t].range(95, 64) = data[2];
					HBM_channelA3[offset_c + t].range(127, 96) = data[3];
					HBM_channelA3[offset_c + t].range(159, 128) = data[4];
					HBM_channelA3[offset_c + t].range(191, 160) = data[5];
					HBM_channelA3[offset_c + t].range(223, 192) = data[6];
					HBM_channelA3[offset_c + t].range(255, 224) = data[7];
					HBM_channelA3[offset_c + t].range(287, 256) = data[8];
					HBM_channelA3[offset_c + t].range(319, 288) = data[9];
					HBM_channelA3[offset_c + t].range(351, 320) = data[10];
					HBM_channelA3[offset_c + t].range(383, 352) = data[11];
					HBM_channelA3[offset_c + t].range(415, 384) = data[12];
					HBM_channelA3[offset_c + t].range(447, 416) = data[13];
					HBM_channelA3[offset_c + t].range(479, 448) = data[14];
					HBM_channelA3[offset_c + t].range(511, 480) = data[15];
					HBM_channelB3[offset_c + t].range(31, 0) = data[16];
					HBM_channelB3[offset_c + t].range(63, 32) = data[17];
					HBM_channelB3[offset_c + t].range(95, 64) = data[18];
					HBM_channelB3[offset_c + t].range(127, 96) = data[19];
					HBM_channelB3[offset_c + t].range(159, 128) = data[20];
					HBM_channelB3[offset_c + t].range(191, 160) = data[21];
					HBM_channelB3[offset_c + t].range(223, 192) = data[22];
					HBM_channelB3[offset_c + t].range(255, 224) = data[23];
					HBM_channelB3[offset_c + t].range(287, 256) = data[24];
					HBM_channelB3[offset_c + t].range(319, 288) = data[25];
					HBM_channelB3[offset_c + t].range(351, 320) = data[26];
					HBM_channelB3[offset_c + t].range(383, 352) = data[27];
					HBM_channelB3[offset_c + t].range(415, 384) = data[28];
					HBM_channelB3[offset_c + t].range(447, 416) = data[29];
					HBM_channelB3[offset_c + t].range(479, 448) = data[30];
					HBM_channelB3[offset_c + t].range(511, 480) = data[31];
					HBM_channelA4[offset_c + t].range(31, 0) = data[0];
					HBM_channelA4[offset_c + t].range(63, 32) = data[1];
					HBM_channelA4[offset_c + t].range(95, 64) = data[2];
					HBM_channelA4[offset_c + t].range(127, 96) = data[3];
					HBM_channelA4[offset_c + t].range(159, 128) = data[4];
					HBM_channelA4[offset_c + t].range(191, 160) = data[5];
					HBM_channelA4[offset_c + t].range(223, 192) = data[6];
					HBM_channelA4[offset_c + t].range(255, 224) = data[7];
					HBM_channelA4[offset_c + t].range(287, 256) = data[8];
					HBM_channelA4[offset_c + t].range(319, 288) = data[9];
					HBM_channelA4[offset_c + t].range(351, 320) = data[10];
					HBM_channelA4[offset_c + t].range(383, 352) = data[11];
					HBM_channelA4[offset_c + t].range(415, 384) = data[12];
					HBM_channelA4[offset_c + t].range(447, 416) = data[13];
					HBM_channelA4[offset_c + t].range(479, 448) = data[14];
					HBM_channelA4[offset_c + t].range(511, 480) = data[15];
					HBM_channelB4[offset_c + t].range(31, 0) = data[16];
					HBM_channelB4[offset_c + t].range(63, 32) = data[17];
					HBM_channelB4[offset_c + t].range(95, 64) = data[18];
					HBM_channelB4[offset_c + t].range(127, 96) = data[19];
					HBM_channelB4[offset_c + t].range(159, 128) = data[20];
					HBM_channelB4[offset_c + t].range(191, 160) = data[21];
					HBM_channelB4[offset_c + t].range(223, 192) = data[22];
					HBM_channelB4[offset_c + t].range(255, 224) = data[23];
					HBM_channelB4[offset_c + t].range(287, 256) = data[24];
					HBM_channelB4[offset_c + t].range(319, 288) = data[25];
					HBM_channelB4[offset_c + t].range(351, 320) = data[26];
					HBM_channelB4[offset_c + t].range(383, 352) = data[27];
					HBM_channelB4[offset_c + t].range(415, 384) = data[28];
					HBM_channelB4[offset_c + t].range(447, 416) = data[29];
					HBM_channelB4[offset_c + t].range(479, 448) = data[30];
					HBM_channelB4[offset_c + t].range(511, 480) = data[31];
					HBM_channelA5[offset_c + t].range(31, 0) = data[0];
					HBM_channelA5[offset_c + t].range(63, 32) = data[1];
					HBM_channelA5[offset_c + t].range(95, 64) = data[2];
					HBM_channelA5[offset_c + t].range(127, 96) = data[3];
					HBM_channelA5[offset_c + t].range(159, 128) = data[4];
					HBM_channelA5[offset_c + t].range(191, 160) = data[5];
					HBM_channelA5[offset_c + t].range(223, 192) = data[6];
					HBM_channelA5[offset_c + t].range(255, 224) = data[7];
					HBM_channelA5[offset_c + t].range(287, 256) = data[8];
					HBM_channelA5[offset_c + t].range(319, 288) = data[9];
					HBM_channelA5[offset_c + t].range(351, 320) = data[10];
					HBM_channelA5[offset_c + t].range(383, 352) = data[11];
					HBM_channelA5[offset_c + t].range(415, 384) = data[12];
					HBM_channelA5[offset_c + t].range(447, 416) = data[13];
					HBM_channelA5[offset_c + t].range(479, 448) = data[14];
					HBM_channelA5[offset_c + t].range(511, 480) = data[15];
					HBM_channelB5[offset_c + t].range(31, 0) = data[16];
					HBM_channelB5[offset_c + t].range(63, 32) = data[17];
					HBM_channelB5[offset_c + t].range(95, 64) = data[18];
					HBM_channelB5[offset_c + t].range(127, 96) = data[19];
					HBM_channelB5[offset_c + t].range(159, 128) = data[20];
					HBM_channelB5[offset_c + t].range(191, 160) = data[21];
					HBM_channelB5[offset_c + t].range(223, 192) = data[22];
					HBM_channelB5[offset_c + t].range(255, 224) = data[23];
					HBM_channelB5[offset_c + t].range(287, 256) = data[24];
					HBM_channelB5[offset_c + t].range(319, 288) = data[25];
					HBM_channelB5[offset_c + t].range(351, 320) = data[26];
					HBM_channelB5[offset_c + t].range(383, 352) = data[27];
					HBM_channelB5[offset_c + t].range(415, 384) = data[28];
					HBM_channelB5[offset_c + t].range(447, 416) = data[29];
					HBM_channelB5[offset_c + t].range(479, 448) = data[30];
					HBM_channelB5[offset_c + t].range(511, 480) = data[31];
					#else 
				...
				#pragma HLS PIPELINE II=1
					...
					if(n==1){  
						...
						#pragma HLS UNROLL
							...
							#pragma HLS UNROLL
								if(kvdatas[inst][v].key != INVALIDDATA && kvdatas[inst][v].key >= uoffset){ // CRITICAL NEWCHANGE
									unsigned int srcvid_lpv = (kvdatas[inst][v].key - uoffset) >> EDGE_PACK_SIZE_POW; // FIXME.
									vprop_t tmp; tmp.prop = kvdatas[inst][v].value; tmp.mask = MASK_CODE_PE;
									// checkoutofbounds("acts_kernel::ERROR 111202-b::", srcvid_lpv, MAX_UPARTITION_VECSIZE, kvdatas[inst][v].key, uoffset, NAp);
				...
				if(upartition_vertices[p_u].count > 0){
					if(n == 0 && ___use_vertex_centric___ == true){
						...
						if(cummtv2_ >= EDGE_BUFFER_SIZE){
							...
							#ifndef FPGA_IMPL
							else { cout<<"acts_kernel:: ERROR 2367: suitable n not found. EXITING..."<<endl; 
								cout<<"----- max_limit: "<<max_limit<<",  cummtv2_: "<<cummtv2_<<endl; 
								for(unsigned int in=0; in<VALID_NUMPEs; in++){ 
									cout<<"----- cummtv2["<<in<<"]: "<<cummtv2[in]<<endl; 
								}
								exit(EXIT_FAILURE); }
							#endif 
						}
								...
								#pragma HLS PIPELINE II=2
									...
									#pragma HLS UNROLL
										...
										if(edge.dstvid != INVALIDDATA){
											...
											vtemp = res;
											#ifdef _DEBUGMODE_KERNELPRINTS//4 //_DEBUGMODE_KERNELPRINTS_TRACE3
						...
						VC_EXCHANGE_UPDATES_LOOP1: for(unsigned int inst_mirror=0; inst_mirror<VALID_NUMPEs; inst_mirror++){
							VC_EXCHANGE_UPDATES_LOOP1B: for(unsigned int inst=0; inst<VALID_NUMPEs; inst++){
								...
								// #pragma HLS PIPELINE II=2
								#pragma HLS PIPELINE II=3 // VHLS-RESOLUTION
									...
									// checkoutofbounds("acts_kernel::ERROR 111202-a::", (p_v * MAX_CSRUPDATES_VECSIZE_PER__APPLYPARTITION) + updates_buffer___size[inst_mirror][v][p_v], MAX_UPARTITION_VECSIZE, NAp, NAp, NAp);
						...
						#ifdef ___ENABLE___ECPROCESSEDGES___//XXXXXXXXXX // original-correct accurate results
								...
								#pragma HLS PIPELINE II=1
									...
									#pragma HLS UNROLL
										...
										#pragma HLS UNROLL
											...
											if(edge.srcvid != INVALIDDATA && edge.srcvid < MAX_UPARTITION_VECSIZE && uprop.mask == MASK_CODE_PE){
												unsigned int res = process_funcG(uprop.prop, 1);
												unsigned int vtemp_in = min_(uprop.prop, res);
												vtemp_in = res;
												update_in[inst][v].key = edge.dstvid; update_in[inst][v].value = vtemp_in;
											} else {
										...
										// circular shift >>>
										#ifdef RESOLVE_VHLS_TIMING
											MY_LOOP16714: for(unsigned int v=0; v<EDGE_PACK_SIZE; v++){
											#pragma HLS UNROLL
												update_out[inst][v] = update_in[inst][v];
											}
										#else
											rearrangeLayoutVx16B(rotateby, update_in[inst], update_out[inst]); // FIXME.VHLS.TIMING offsets	
											#ifdef _DEBUGMODE_CHECKS3
									...
									#pragma HLS UNROLL
										...
										#pragma HLS UNROLL
											if(t < stats_counts[inst][v]){ 
												...
												updates_vecs[inst].data[v].key = INVALIDDATA; updates_vecs[inst].data[v].value = INVALIDDATA;
												ens[inst][v] = false; 
											}	
											#endif 
										}
						...
						#pragma HLS UNROLL
							...
							#pragma HLS UNROLL	
								...
								if(t < updates_buffer___size[inst][v][p_v]){ 
									// checkoutofbounds("acts_kernel::ERROR 103-b::", voffsett + t, MAX_UPARTITION_VECSIZE, NAp, NAp, NAp);
									vprop_t tmp = retrieve_vdatabuffer(v, voffsett + t, vdata_buffer[inst]); 
								...
								#ifndef RESOLVE_VHLS_TIMING
								else { updates_vecs[inst].data[v].key = INVALIDDATA; updates_vecs[inst].data[v].value = INVALIDDATA; } // VHLS-RESOLUTION
								#endif 
		...
		APPLY_UPDATES_MODULE_LOOP: for(unsigned int p_v=0; p_v<__NUM_APPLYPARTITIONS; p_v++){
			...
			if(vpartition_vertices[0][p_v].count > 0){
						...
						#pragma HLS UNROLL
							if(t < limits[inst]){
								...
								#pragma HLS UNROLL
									...
									if(update.key != INVALIDDATA && update.key < MAX_APPLYPARTITION_SIZE){ // VHLS-RESOLUTION
										#ifdef _DEBUGMODE_CHECKS3
										...
										if(new_vprop != vprop.prop && t < limits[inst]){ // CRITICAL NEWCHANGE
											#ifdef _DEBUGMODE_KERNELPRINTS_TRACE3
				...
				#pragma HLS UNROLL
					...
					// vid_first0[n] = get_global(p_v * MAX_APPLYPARTITION_SIZE, n); 
					// vid_first0[n] = p_v * MAX_APPLYPARTITION_SIZE; // NEW**
				}
				...
				COLLECT_AND_SAVE_FRONTIER_INFO_LOOP1: for(unsigned int p_actvv=0; p_actvv<NUM_ACTVVPARTITIONS_PER_APPLYPARTITION; p_actvv++){
					...
					#pragma HLS PIPELINE II=1
						...
						#pragma HLS UNROLL
							...
							#pragma HLS UNROLL
								#ifndef RESOLVE_VHLS_TIMING
								if(t >= temp_[inst][v]){ actvvs[inst][v].key = INVALIDDATA; actvvs[inst][v].value = INVALIDDATA; } // VHLS-RESOLUTION
								#endif 
								if(t < max_limits[inst]){ ens[inst][v] = true; } else { ens[inst][v] = false; }
							}	
						}
						...
						// dinsertmany_nfrontierdram(offset, p_actvv_, offsets, t, actvvs, ens,  HBM_channelA0, HBM_channelB0, HBM_channelA1, HBM_channelB1, HBM_channelA2, HBM_channelB2, HBM_channelA3, HBM_channelB3, HBM_channelA4, HBM_channelB4, HBM_channelA5, HBM_channelB5);
				...
				if(stats_buffer___size[0][p_v] < threshold___activedstvids && enable___collectactivedstvids == true){
					...
					SAVE_DEST_PROPERTIES_LOOP1: for(unsigned int k=0; k<max_limit; k++){	
						...
						#pragma HLS PIPELINE II=1
							...
							MY_LOOP10302: for(unsigned int n=0; n<VALID_NUMPEs; n++){ // CRITICAL NEWCHANGE
							#pragma HLS UNROLL
					...
					#pragma HLS PIPELINE II=1	
						...
						MY_LOOP10202: for(unsigned int n=0; n<VALID_NUMPEs; n++){ // CRITICAL NEWCHANGE
						#pragma HLS UNROLL
							offsets2[n] = voffset + offsets[n] + t; // CRITICAL REMOVEME
						}
						dinsertmany_vdatadram(voffset, offsets2, t, datas,  HBM_channelA0, HBM_channelB0, HBM_channelA1, HBM_channelB1, HBM_channelA2, HBM_channelB2, HBM_channelA3, HBM_channelB3, HBM_channelA4, HBM_channelB4, HBM_channelA5, HBM_channelB5);
						update_dramnumclockcycles(_NUMCLOCKCYCLES_, ___CODE___SAVE_DEST_PROPERTIES___, 1);
					}
