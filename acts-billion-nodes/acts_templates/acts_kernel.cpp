...
#pragma HLS INTERFACE s_axilite port=return bundle=control
	...
	cout<< TIMINGRESULTSCOLOR << "acts_kernel SUMMARY:: TIME ELAPSE: "<<time_lapse<<". THROUGHPUT: "<<million_edges_per_sec<<" MTEPS; THROUGHPUT: "<<billion_edges_per_sec<<" BTEPS)"<< RESET << endl;
	#endif
	return;
}
