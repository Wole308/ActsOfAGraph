...
#include "/home/centos/src/project_data/oj2zf/ActsOfAGraph/kernels/acts.h"
using namespace std;
...
void randomaccessreduce0(uint512_dt * kvsourcedram, uint512_dt * kvdestdram, globalparams_t globalparams){
	#ifdef TRADITIONAL
