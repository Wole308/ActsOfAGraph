...
public:
	...
	void workerthread_launchkernel_acts(unsigned int ithreadidx, uint512_vec_dt * kvsourcedram, uint512_vec_dt * kvdestdram, keyvalue_t * kvstats);
	void workerthread_launchkernel_actslwtype1(unsigned int ithreadidx, uint512_vec_dt * kvsourcedram);
	void workerthread_launchkernel_actslwtype2(unsigned int ithreadidx, uint512_vec_dt * kvsourcedram1, uint512_vec_dt * kvsourcedram2);
