...
uint512_dt * kvdramA
	...
	// WRITE
	void write_fake_ddr0_w0_sw0(uint512_dt * kvdram, uint512_dt kvbuffer[KVDESTBUFFERSZ_KVS], unsigned int dramoffset_kvs, unsigned int bramoffset_kvs, unsigned int size_kvs);
	void write_fake_ddr0_w0_sw1(uint512_dt * kvdram, uint512_dt kvbuffer[KVDESTBUFFERSZ_KVS], unsigned int dramoffset_kvs, unsigned int bramoffset_kvs, unsigned int size_kvs);
	void write_fake_ddr0_w0_sw2(uint512_dt * kvdram, uint512_dt kvbuffer[KVDESTBUFFERSZ_KVS], unsigned int dramoffset_kvs, unsigned int bramoffset_kvs, unsigned int size_kvs);
	void write_fake_ddr0_w0_sw3(uint512_dt * kvdram, uint512_dt kvbuffer[KVDESTBUFFERSZ_KVS], unsigned int dramoffset_kvs, unsigned int bramoffset_kvs, unsigned int size_kvs);
	void write_fake_ddr0_w0_sw4(uint512_dt * kvdram, uint512_dt kvbuffer[KVDESTBUFFERSZ_KVS], unsigned int dramoffset_kvs, unsigned int bramoffset_kvs, unsigned int size_kvs);
	void write_fake_ddr0_w0_sw5(uint512_dt * kvdram, uint512_dt kvbuffer[KVDESTBUFFERSZ_KVS], unsigned int dramoffset_kvs, unsigned int bramoffset_kvs, unsigned int size_kvs);
	void write_fake_ddr0_w0_sw6(uint512_dt * kvdram, uint512_dt kvbuffer[KVDESTBUFFERSZ_KVS], unsigned int dramoffset_kvs, unsigned int bramoffset_kvs, unsigned int size_kvs);
	void write_fake_ddr0_w0_sw7(uint512_dt * kvdram, uint512_dt kvbuffer[KVDESTBUFFERSZ_KVS], unsigned int dramoffset_kvs, unsigned int bramoffset_kvs, unsigned int size_kvs);
	void write_fake_ddr1_w0_sw0(uint512_dt * kvdram, uint512_dt kvbuffer[KVDESTBUFFERSZ_KVS], unsigned int dramoffset_kvs, unsigned int bramoffset_kvs, unsigned int size_kvs);
	void write_fake_ddr1_w0_sw1(uint512_dt * kvdram, uint512_dt kvbuffer[KVDESTBUFFERSZ_KVS], unsigned int dramoffset_kvs, unsigned int bramoffset_kvs, unsigned int size_kvs);
	void write_fake_ddr1_w0_sw2(uint512_dt * kvdram, uint512_dt kvbuffer[KVDESTBUFFERSZ_KVS], unsigned int dramoffset_kvs, unsigned int bramoffset_kvs, unsigned int size_kvs);
	void write_fake_ddr1_w0_sw3(uint512_dt * kvdram, uint512_dt kvbuffer[KVDESTBUFFERSZ_KVS], unsigned int dramoffset_kvs, unsigned int bramoffset_kvs, unsigned int size_kvs);
	void write_fake_ddr1_w0_sw4(uint512_dt * kvdram, uint512_dt kvbuffer[KVDESTBUFFERSZ_KVS], unsigned int dramoffset_kvs, unsigned int bramoffset_kvs, unsigned int size_kvs);
	void write_fake_ddr1_w0_sw5(uint512_dt * kvdram, uint512_dt kvbuffer[KVDESTBUFFERSZ_KVS], unsigned int dramoffset_kvs, unsigned int bramoffset_kvs, unsigned int size_kvs);
	void write_fake_ddr1_w0_sw6(uint512_dt * kvdram, uint512_dt kvbuffer[KVDESTBUFFERSZ_KVS], unsigned int dramoffset_kvs, unsigned int bramoffset_kvs, unsigned int size_kvs);
	void write_fake_ddr1_w0_sw7(uint512_dt * kvdram, uint512_dt kvbuffer[KVDESTBUFFERSZ_KVS], unsigned int dramoffset_kvs, unsigned int bramoffset_kvs, unsigned int size_kvs);
	void write_fake_ddr2_w0_sw0(uint512_dt * kvdram, uint512_dt kvbuffer[KVDESTBUFFERSZ_KVS], unsigned int dramoffset_kvs, unsigned int bramoffset_kvs, unsigned int size_kvs);
	void write_fake_ddr2_w0_sw1(uint512_dt * kvdram, uint512_dt kvbuffer[KVDESTBUFFERSZ_KVS], unsigned int dramoffset_kvs, unsigned int bramoffset_kvs, unsigned int size_kvs);
	void write_fake_ddr2_w0_sw2(uint512_dt * kvdram, uint512_dt kvbuffer[KVDESTBUFFERSZ_KVS], unsigned int dramoffset_kvs, unsigned int bramoffset_kvs, unsigned int size_kvs);
	void write_fake_ddr2_w0_sw3(uint512_dt * kvdram, uint512_dt kvbuffer[KVDESTBUFFERSZ_KVS], unsigned int dramoffset_kvs, unsigned int bramoffset_kvs, unsigned int size_kvs);
	void write_fake_ddr2_w0_sw4(uint512_dt * kvdram, uint512_dt kvbuffer[KVDESTBUFFERSZ_KVS], unsigned int dramoffset_kvs, unsigned int bramoffset_kvs, unsigned int size_kvs);
	void write_fake_ddr2_w0_sw5(uint512_dt * kvdram, uint512_dt kvbuffer[KVDESTBUFFERSZ_KVS], unsigned int dramoffset_kvs, unsigned int bramoffset_kvs, unsigned int size_kvs);
	void write_fake_ddr2_w0_sw6(uint512_dt * kvdram, uint512_dt kvbuffer[KVDESTBUFFERSZ_KVS], unsigned int dramoffset_kvs, unsigned int bramoffset_kvs, unsigned int size_kvs);
	void write_fake_ddr2_w0_sw7(uint512_dt * kvdram, uint512_dt kvbuffer[KVDESTBUFFERSZ_KVS], unsigned int dramoffset_kvs, unsigned int bramoffset_kvs, unsigned int size_kvs);
	void write_fake_ddr3_w0_sw0(uint512_dt * kvdram, uint512_dt kvbuffer[KVDESTBUFFERSZ_KVS], unsigned int dramoffset_kvs, unsigned int bramoffset_kvs, unsigned int size_kvs);
	void write_fake_ddr3_w0_sw1(uint512_dt * kvdram, uint512_dt kvbuffer[KVDESTBUFFERSZ_KVS], unsigned int dramoffset_kvs, unsigned int bramoffset_kvs, unsigned int size_kvs);
	void write_fake_ddr3_w0_sw2(uint512_dt * kvdram, uint512_dt kvbuffer[KVDESTBUFFERSZ_KVS], unsigned int dramoffset_kvs, unsigned int bramoffset_kvs, unsigned int size_kvs);
	void write_fake_ddr3_w0_sw3(uint512_dt * kvdram, uint512_dt kvbuffer[KVDESTBUFFERSZ_KVS], unsigned int dramoffset_kvs, unsigned int bramoffset_kvs, unsigned int size_kvs);
	void write_fake_ddr3_w0_sw4(uint512_dt * kvdram, uint512_dt kvbuffer[KVDESTBUFFERSZ_KVS], unsigned int dramoffset_kvs, unsigned int bramoffset_kvs, unsigned int size_kvs);
	void write_fake_ddr3_w0_sw5(uint512_dt * kvdram, uint512_dt kvbuffer[KVDESTBUFFERSZ_KVS], unsigned int dramoffset_kvs, unsigned int bramoffset_kvs, unsigned int size_kvs);
	void write_fake_ddr3_w0_sw6(uint512_dt * kvdram, uint512_dt kvbuffer[KVDESTBUFFERSZ_KVS], unsigned int dramoffset_kvs, unsigned int bramoffset_kvs, unsigned int size_kvs);
	void write_fake_ddr3_w0_sw7(uint512_dt * kvdram, uint512_dt kvbuffer[KVDESTBUFFERSZ_KVS], unsigned int dramoffset_kvs, unsigned int bramoffset_kvs, unsigned int size_kvs);
	
	void writeburst_ddr0_w0_sw0(uint512_dt * kvdram, unsigned int baseaddr_kvs, unsigned int dramoffset_kvs, unsigned int offset_kvs, unsigned int size_kvs, uint512_dt kvbuffer[KVSRCBUFFERSZ_KVS]);
	void writeburst_ddr0_w0_sw1(uint512_dt * kvdram, unsigned int baseaddr_kvs, unsigned int dramoffset_kvs, unsigned int offset_kvs, unsigned int size_kvs, uint512_dt kvbuffer[KVSRCBUFFERSZ_KVS]);
	void writeburst_ddr0_w0_sw2(uint512_dt * kvdram, unsigned int baseaddr_kvs, unsigned int dramoffset_kvs, unsigned int offset_kvs, unsigned int size_kvs, uint512_dt kvbuffer[KVSRCBUFFERSZ_KVS]);
	void writeburst_ddr0_w0_sw3(uint512_dt * kvdram, unsigned int baseaddr_kvs, unsigned int dramoffset_kvs, unsigned int offset_kvs, unsigned int size_kvs, uint512_dt kvbuffer[KVSRCBUFFERSZ_KVS]);
	void writeburst_ddr0_w0_sw4(uint512_dt * kvdram, unsigned int baseaddr_kvs, unsigned int dramoffset_kvs, unsigned int offset_kvs, unsigned int size_kvs, uint512_dt kvbuffer[KVSRCBUFFERSZ_KVS]);
	void writeburst_ddr0_w0_sw5(uint512_dt * kvdram, unsigned int baseaddr_kvs, unsigned int dramoffset_kvs, unsigned int offset_kvs, unsigned int size_kvs, uint512_dt kvbuffer[KVSRCBUFFERSZ_KVS]);
	void writeburst_ddr0_w0_sw6(uint512_dt * kvdram, unsigned int baseaddr_kvs, unsigned int dramoffset_kvs, unsigned int offset_kvs, unsigned int size_kvs, uint512_dt kvbuffer[KVSRCBUFFERSZ_KVS]);
	void writeburst_ddr0_w0_sw7(uint512_dt * kvdram, unsigned int baseaddr_kvs, unsigned int dramoffset_kvs, unsigned int offset_kvs, unsigned int size_kvs, uint512_dt kvbuffer[KVSRCBUFFERSZ_KVS]);
	...
	// WRITE MANY
	void writemany_ddr0_w0(unsigned int ssdpartitonid, unsigned int beginworkerid, uint512_dt * kvdram, unsigned int baseaddr_kvs, unsigned int currentLOP, unsigned int destpartitionoffset	
