...
cudaError_t Advance(const GraphT &graph, FrontierInT *frontier_in,
                    ...
                    OpT op) {
	// util::PrintMsg("[### I seen you: /net/bigtemp/oj2zf/gunrock_wole/gunrock/oprtr/oprtr.cuh/Advance 1]", true);
...
cudaError_t Advance(const GraphT &graph, FrontierInT *frontier_in,
	...
	// util::PrintMsg("[### I seen you: /net/bigtemp/oj2zf/gunrock_wole/gunrock/oprtr/oprtr.cuh/Advance 2]", true);
  return oprtr::advance::Launch<FLAG>(graph, frontier_in, frontier_out,
...
cudaError_t Filter(const GraphT graph, FrontierInT *frontier_in,
                   FrontierOutT *frontier_out, ParametersT &parameters,
                   OpT op) {
	// util::PrintMsg("[### I seen you: /net/bigtemp/oj2zf/gunrock_wole/gunrock/oprtr/oprtr.cuh/Filter 1]", true);
...
cudaError_t Filter(const GraphT graph, FrontierInT *frontier_in,
                   FrontierOutT *frontier_out, ParametersT &parameters,
                   Op1T op1, Op2T op2) {
	// util::PrintMsg("[### I seen you: /net/bigtemp/oj2zf/gunrock_wole/gunrock/oprtr/oprtr.cuh/Filter 2]", true);
  return oprtr::filter::Launch<FLAG>(graph, frontier_in, frontier_out,
                                     parameters, op1, op2);
}
...
cudaError_t Compute(const GraphT graph, FrontierInT *frontier_in,
                    FrontierOutT *frontier_out, ParametersT &parameters,
                    OpT op) {
	// util::PrintMsg("[### I seen you: /net/bigtemp/oj2zf/gunrock_wole/gunrock/oprtr/oprtr.cuh/Compute 1]", true);
...
cudaError_t Compute(const GraphT graph, FrontierInT *frontier_in,
                    FrontierOutT *frontier_out, ParametersT &parameters,
                    Op1T op1, Op2T op2) {
	// util::PrintMsg("[### I seen you: /net/bigtemp/oj2zf/gunrock_wole/gunrock/oprtr/oprtr.cuh/Compute 2]", true);
  // return oprtr::compute::Launch<FLAG>(
...
cudaError_t NeighborReduce(const GraphT &graph, FrontierInT *frontier_in,
                           ...
                           ValueT init_val) {
	// util::PrintMsg("[### I seen you: /net/bigtemp/oj2zf/gunrock_wole/gunrock/oprtr/oprtr.cuh/NeighborReduce 1]", true);
...
cudaError_t Intersect(const GraphT graph, FrontierInT *frontier_in,
                      FrontierOutT *frontier_out, ParametersT &parameters,
                      OpT op) {
	// util::PrintMsg("[### I seen you: /net/bigtemp/oj2zf/gunrock_wole/gunrock/oprtr/oprtr.cuh/Intersect 1]", true);
  cudaError_t retval = cudaSuccess;
...
cudaError_t Launch(const GraphT graph, FrontierInT *frontier_in,
                   FrontierOutT *frontier_out, ParametersT &parameters,
                   OpT op) {
	// util::PrintMsg("[### I seen you: /net/bigtemp/oj2zf/gunrock_wole/gunrock/oprtr/oprtr.cuh/Launch 1]", true);
  // cudaError_t retval = cudaSuccess;
...
cudaError_t Launch(const GraphT graph, FrontierInT *frontier_in,
                   FrontierOutT *frontier_out, ParametersT &parameters,
                   Op1T op1, Op2T op2) {
	// util::PrintMsg("[### I seen you: /net/bigtemp/oj2zf/gunrock_wole/gunrock/oprtr/oprtr.cuh/Launch 2]", true);
  // cudaError_t retval = cudaSuccess;
  if (parameters.oprtr_type == "Advance")
    return oprtr::advance::Launch<FLAG>(graph, frontier_in, frontier_out,
                                        parameters, op1, op2);
