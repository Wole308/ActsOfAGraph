...
# Building kernel
$(XCLBIN)/topkernel.$(TARGET).$(DSA).xo: acts/parallelacts/actsthread_partition.cpp
	mkdir -p $(XCLBIN)
...
$(EXECUTABLE): check-xrt $(HOST_SRCS) $(HOST_HDRS)
	$(CXX) $(CXXFLAGS) $(HOST_SRCS)	$(GRAPH_CPP) $(SRFLAGS) -I$(SORTREDUCE_INCLUDE) -I$(GRAPH_SRC) -L$(SORTREDUCE_LIB) -lsortreduce -pthread -laio -march=native -lrt $(HOST_HDRS) -o '$@' $(LDFLAGS)
