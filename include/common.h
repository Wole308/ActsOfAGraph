...
#define MESSAGES_RETURNVALUES_CHKPT1_NUMEDGESPROCESSED 0
...
#define MESSAGES_GPMODE (MESSAGES_ENABLE_APPLYUPDATESCOMMAND + 1)
...
#define MESSAGES_THRESHOLD_HYBRIDGPMODE_MAXVTHRESHOLD (MESSAGES_EVALUATION_ACTS_VERYBARE + 1)
#define MESSAGES_THRESHOLD_HYBRIDGPMODE_MAXVTHRESHOLD_PER_VPARTITION (MESSAGES_THRESHOLD_HYBRIDGPMODE_MAXVTHRESHOLD + 1)

#define MESSAGES_BASEOFFSETKVS_MESSAGESDATA (MESSAGES_THRESHOLD_HYBRIDGPMODE_MAXVTHRESHOLD_PER_VPARTITION + 1)
...
#define MESSAGES_ACTSPARAMS_TOTALDRAMCAPACITY_KVS (MESSAGES_ACTSPARAMS_WORKBUFFER_SIZE + 1)
#define MESSAGES_ACTSPARAMS_VPTR_SHRINK_RATIO (MESSAGES_ACTSPARAMS_TOTALDRAMCAPACITY_KVS + 1) /////////////////////// pass through loadgraph.cpp
#define MESSAGES_ACTSPARAMS_UNUSED3 (MESSAGES_ACTSPARAMS_VPTR_SHRINK_RATIO + 1)
#define MESSAGES_ACTSPARAMS_UNUSED4 (MESSAGES_ACTSPARAMS_UNUSED3 + 1)

#define MESSAGES_DUMMYCHKPOINT (MESSAGES_ACTSPARAMS_UNUSED4 + 1)
...
#define MAX_BLOCKRAM_VDEST2DATA_SIZE 1	
...
#define MAX_TOTALDRAMCAPACITY_V ((1 << 28) / 4) // (256MB/4=64M)
#define MAX_TOTALDRAMCAPACITY_KV ((1 << 28) / 8) // (256MB/8=32M)
#define MAX_TOTALDRAMCAPACITY_VS (MAX_TOTALDRAMCAPACITY_V / VECTOR2_SIZE) // (64M/16=4M)
#define MAX_TOTALDRAMCAPACITY_KVS (MAX_TOTALDRAMCAPACITY_KV / VECTOR_SIZE) // (32M/8=4M)
#define MAX_KVSOURCEDRAMSZ (MAX_TOTALDRAMCAPACITY_KVS * VECTOR_SIZE) // max HBM capacity (256MB)
...
// #define MAX_KVDATA_RANGE (1 << ) // FIXME.
...
// #if defined(ALGORITHMTYPE_REPRESENTVDATASASBITS) // {1st 16 is masks}{2nd 16 is vdatas} (see classname__mem_convert_and_access.cpp)
...
typedef struct {
	...
	unsigned int THRESHOLD_HYBRIDGPMODE_MAXVTHRESHOLD;
	unsigned int THRESHOLD_HYBRIDGPMODE_MAXVTHRESHOLD_PER_VPARTITION;
	...
	unsigned int ACTSPARAMS_TOTALDRAMCAPACITY_KVS;
	unsigned int ACTSPARAMS_VPTR_SHRINK_RATIO;
	unsigned int ACTSPARAMS_UNUSED3;
...
typedef struct {
	...
	unsigned int KVDRAMWORKCAPACITY_BYTES;
	...
	unsigned int TOTALDRAMCAPACITY_V; // (256MB/4=64M)
	unsigned int TOTALDRAMCAPACITY_KV; // (256MB/8=32M)
	unsigned int TOTALDRAMCAPACITY_VS; // (64M/16=4M)
	unsigned int TOTALDRAMCAPACITY_KVS; // (32M/8=4M)
	unsigned int KVSOURCEDRAMSZ; // TOTALDRAMCAPACITY_KV // max HBM capacity (256MB)
