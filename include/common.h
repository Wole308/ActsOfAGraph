...
#define PROCESSPARTITIONSZ ((SRAMSZ / NUM_PEs) * NUM_PEs * VDATA_PACKINGSIZE) // 16128 making sure its reconcillable to VECTOR2_SIZE
...
// #define NUMPROCESSEDGESPARTITIONS ((KVDATA_RANGE / NUM_PEs) / PROCESSPARTITIONSZ)
...
#define VPARTITION_SHRINK_RATIO 4 // {mem_access.cpp}
...
#define MESSAGES_ACTSCONFIG_INSERTSTATSMETADATAINEDGES (MESSAGES_ENABLE_SAVEVMASK + 1) // USED FOR PASSING CONFIG_INSERTSTATSMETADATAINEDGES
...
#define MESSAGES_RETURN_RETURNVALUES (MESSAGES_DUMMYCHKPOINT + 1)
