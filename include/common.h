...
#define MESSAGES_VOLUMEOFFSETKVS_WORKDATA (MESSAGES_BASEOFFSETKVS_MESSAGESDATA + 1)
#define MESSAGES_VOLUMEOFFSETKVS_WORKSPACEDATA (MESSAGES_VOLUMEOFFSETKVS_WORKDATA + 1)
