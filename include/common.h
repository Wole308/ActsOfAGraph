...
// #define ___ENABLE___DYNAMICGRAPHANALYTICS___PROCESSRAWEDGEUPDATES___ // ___ENABLE___DYNAMICGRAPHANALYTICS___PROCESSRAWEDGEUPDATES___s
#define ___ENABLE___DYNAMICGRAPHANALYTICS___

#define ALL_MODULES 222
#define ALL_P_Us 333
#define ALL_LLP_SETs 444
#define ALL_LLP_IDs 555
#define ALL_P_Vs 666
#define ALL_P_TRANSPORTs 777
...
#define GLOBALPARAMSCODE___ENABLE___PROCESSEDGES 61
#define GLOBALPARAMSCODE___ENABLE___READ_FRONTIER_PROPERTIES 62
#define GLOBALPARAMSCODE___ENABLE___VCPROCESSEDGES 63
#define GLOBALPARAMSCODE___ENABLE___ECUPDATEEDGES 64
#define GLOBALPARAMSCODE___ENABLE___ECPROCESSEDGES 65
#define GLOBALPARAMSCODE___ENABLE___SAVEVCUPDATES 66
#define GLOBALPARAMSCODE___ENABLE___COLLECTACTIVEDSTVIDS 67
#define GLOBALPARAMSCODE___ENABLE___APPLYUPDATESMODULE 68
#define GLOBALPARAMSCODE___ENABLE___READ_DEST_PROPERTIES 69
#define GLOBALPARAMSCODE___ENABLE___APPLYUPDATES 70
#define GLOBALPARAMSCODE___ENABLE___COLLECT_AND_SAVE_FRONTIER_PROPERTIES 71
#define GLOBALPARAMSCODE___ENABLE___SAVE_DEST_PROPERTIES 72
#define GLOBALPARAMSCODE___ENABLE___EXCHANGEFRONTIERINFOS 73
...
typedef struct {
	unsigned int module;
	unsigned int p_u;
    unsigned int llp_set;
	unsigned int llp_id;
	unsigned int p_v;
	unsigned int p_transport;
} action_t;
