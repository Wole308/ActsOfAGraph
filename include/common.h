...
#define UNITKVDATA_BATCHSIZE 10000000
#endif 
#ifdef BFS_ALGORITHM
...
#define MESSAGES_BASEOFFSETKVS_STATSDRAM (MESSAGES_BASEOFFSETKVS_VERTICESDATAMASK + 1)
...
#define MESSAGES_SIZE_KVSTATSDRAM (MESSAGES_SIZE_VERTICESDATAMASK + 1)
#define MESSAGES_SIZE_KVDRAM (MESSAGES_SIZE_KVSTATSDRAM + 1)
#define MESSAGES_SIZE_KVDRAMWORKSPACE (MESSAGES_SIZE_KVDRAM + 1)
#define MESSAGES_SIZE_APPLYVERTEXBUFFER (MESSAGES_SIZE_KVDRAMWORKSPACE + 1)
#define MESSAGES_SIZE_BATCHRANGE (MESSAGES_SIZE_APPLYVERTEXBUFFER + 1)
...
#define MESSAGES_POW_APPLYVERTEXBUFFER (MESSAGES_POW_KVDRAMWORKSPACE + 1)
#define MESSAGES_POW_BATCHRANGE (MESSAGES_POW_APPLYVERTEXBUFFER + 1)
