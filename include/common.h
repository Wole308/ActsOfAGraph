...
#define NFACTOR 4
#define PADDEDDESTBUFFER_SIZE ((1 << SRAMSZ_POW) / VECTOR_SIZE) // NEWCHANGE. HARDWARECOMPLAINT. using > 2048 drastically dropped frequency 
...
#ifdef ACTSMODEL_LW
#define BASEOFFSET2_VERTICESDATA (BASEOFFSET_CAPSULES + BATCH_RANGE) // 
#define BASEOFFSET2_VERTICESDATA_KVS (BASEOFFSET2_VERTICESDATA / VECTOR_SIZE) // 

#define BASEOFFSET2_MESSAGESDRAM (BASEOFFSET2_VERTICESDATA + MESSAGESDRAMSZ) // 
#define BASEOFFSET2_MESSAGESDRAM_KVS (BASEOFFSET2_MESSAGESDRAM / VECTOR_SIZE) // 

#define BASEOFFSET2_STATSDRAM (BASEOFFSET2_MESSAGESDRAM + MESSAGESDRAMSZ) // 
#define BASEOFFSET2_STATSDRAM_KVS (BASEOFFSET2_STATSDRAM / VECTOR_SIZE) //

#define BASEOFFSET2_CAPSULEMETADATA (BASEOFFSET2_STATSDRAM + CAPSULEMETADATADRAMSZ) //
#define BASEOFFSET2_CAPSULEMETADATA_KVS (BASEOFFSET2_CAPSULEMETADATA / VECTOR_SIZE) //
#endif 

#ifdef ACTSMODEL_LW
#define KVSOURCEDRAMSZ (KVDRAMBUFFERSZ + KVDRAMSZ + KVDRAMWORKSPACESZ + CAPSULESZ + BATCH_RANGE + MESSAGESDRAMSZ + STATSDRAMSZ + CAPSULEMETADATADRAMSZ)
#else 
