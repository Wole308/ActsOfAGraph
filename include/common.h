...
#define MESSAGES_RETURNVALUES_STATSCOLLECTED 0
// #define MESSAGES_RETURNVALUES_NUMVERTICESTRAVERSED 32
// #define MESSAGES_HOSTRETURNVALUES_NUMEDGESPROCESSED 64
// #define MESSAGES_HOSTRETURNVALUES_NUMVERTICESREDUCED 96
// #define MESSAGES_HOSTRETURNVALUES_NUMDRAMREADS 128
// #define MESSAGES_HOSTRETURNVALUES_NUMDRAMWRITES 129
...
#define MESSAGES_BASEOFFSETKVS_EDGES0DATA (MESSAGES_VOLUMEOFFSETKVS_WORKSPACEDATA + 1)
#define MESSAGES_BASEOFFSETKVS_EDGESDATA (MESSAGES_BASEOFFSETKVS_EDGES0DATA + 1)
...
#define MESSAGES_BASEOFFSETKVS_ACTIVEVERTICESDATA (MESSAGES_BASEOFFSETKVS_DESTVERTICESDATA + 1)
#define MESSAGES_BASEOFFSETKVS_ACTIVEUPROPBLOCKS (MESSAGES_BASEOFFSETKVS_ACTIVEVERTICESDATA + 1)
...
#define MESSAGES_SIZE_EDGES0 (MESSAGES_VOLUMESIZEU32_WORKSPACEDATA + 1)
#define MESSAGES_SIZE_EDGES (MESSAGES_SIZE_EDGES0 + 1)
...
#define MESSAGES_SIZE_ACTIVEVERTICESDATA (MESSAGES_SIZE_DESTVERTICESDATA + 1)
#define MESSAGES_SIZE_ACTIVEUPROPBLOCKS (MESSAGES_SIZE_ACTIVEVERTICESDATA + 1)
...
#define MESSAGES_POW_EDGES0 (MESSAGES_POW_MESSAGESDRAM + 1)
#define MESSAGES_POW_EDGES (MESSAGES_POW_EDGES0 + 1)
...
#define READDATAMODE 8
#define SAVEDATAMODE 9
...
#define MAX_PROC_SRAMSZ_POW 13

/// (=122880 vertices/vpartition)(=7680 kvs/vpartition)(=320 kvs/vpartition/channel)
#define VDATA_SUBPARTITION_SIZE 320
#define VDATA_SUBPARTITION_OFFLINESIZE VDATA_SUBPARTITION_SIZE // 16, VDATA_SUBPARTITION_SIZE
#define NUM_SUBPARTITIONS_PER_VPARTITION NUM_PEs // 24

#define NUM_VERTICES_PER_UPROPBLOCK 256 // { 64*, 256 }
#define NUM_VERTICESKVS_PER_UPROPBLOCK (NUM_VERTICES_PER_UPROPBLOCK / VDATA_PACKINGSIZE) // { 4, 16 }
#define NUM_UPROPBLOCKS_PER_VPARTITION ((VDATA_SUBPARTITION_SIZE * NUM_PEs) / NUM_VERTICESKVS_PER_UPROPBLOCK) // { 1920, 480 }

#define MAXNUM_UPROPBLOCKS_PER_VPARTITION 2048 // { 1024, 2048 }
#define MAXNUM_EDGEBLOCKS_PER_VPARTITION 2048 // { 1024, 2048 } 
#define MAXNUM_UPDATEBLOCKS_PER_VPARTITION 2048 // { 1024, 2048 }

#define MAX_RED_SRAMSZ_POW 13
...
#define MAX_BLOCKRAM_ACTVVINDEX_SIZE 1
...
// #define MAXNUMGRAPHITERATIONS 32
...
#define NUM_COLLECTIONS 8 // 16
#define COLLECTIONS_BUFFERSZ 16//2 // NEWCHANGE.
// category 1
#define PROCESSINGPHASE_TRANSFSZ_COLLECTIONID 0
#define PARTITIONINGPHASE_TRANSFSZ_COLLECTIONID 1
#define REDUCEPHASE_TRANSFSZ_COLLECTIONID 2
#define BROADCASTPHASE_TRANSFSZ_COLLECTIONID 3
#define SYNCPHASE_TRANSFSZ_COLLECTIONID 4
// category 2
#define NUMEDGESPROCESSED_COLLECTIONID 5
#define NUMVERTICESPROCESSED_COLLECTIONID 6
// category 3
#define NUMREADSFROMDRAM_COLLECTIONID 7
#define NUMWRITESTODRAM_COLLECTIONID 8

#define REPORT__DRAM_ACCESS_LATENCY 0//16 // CRITICAL FIXME.
#define REPORT__SPARSEPROCESS_SLOWDOWN_FACTOR 4
...
// #define ACTVVID_BITSZ 16
// #define MASK_ACTVVID 0b00000000000000111111111111111111
#define ACTVVID_BITSZ 28
#define MASK_ACTVVID 0x0FFFFFFF
#define MASK_ACTVATA 0x0000000F

#define EDGESTATSRAM_SIZE BLOCKRAM_SIZE
...
typedef struct {
	...
	unsigned int NUMVERTEXBLOCKPARTITIONS;
