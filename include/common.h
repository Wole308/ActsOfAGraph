...
#define PROCESSPARTITIONSZ 16384 //  REDUCEPARTITIONSZ // 16384
...
#define KVDRAMWORKCAPACITY_BYTES 256000000	
	...
	#define SIZEOF_DSTV_IN_EDGEDSTVDATA 28
	#define OFFSETOF_SRCV_IN_EDGEDSTVDATA 28
	#define SIZEOF_SRCV_IN_EDGEDSTVDATA 4
