...
#define BFS_ALGORITHM // PR_ALGORITHM, CF_ALGORITHM, HITS_ALGORITHM, CC_ALGORITHM, SSSP_ALGORITHM, BFS_ALGORITHM
...
#define NUMINSTANCES 1
	...
	// #define SRAMSZ_POW 10
#else
	#define SRAMSZ_POW 14 // 16384, 8192
#endif
...
// #define TREE_DEPTH ((((BATCH_RANGE_POW - VDATA_SHRINK_RATIO_POW) - SRAMSZ_POW) + (NUM_PARTITIONS_POW - 1)) / NUM_PARTITIONS_POW)
#else 
#define TREE_DEPTH 1
#endif
...
#define NUMREDUCEPARTITIONS (((KVDATA_RANGE / NUM_PEs) + (REDUCEPARTITIONSZ-1)) / REDUCEPARTITIONSZ) // 11 // FIXME: 
...
#define VMASKBUFFERSZ_KVS (REDUCEPARTITIONSZ / 512) // 32 //>>> 16384=[WidthxHeight*]=512*32 [OBSOLETE]
#define FACTOR_REDUCEPARTITIONSZ_VMASKSZ (REDUCEPARTITIONSZ_KVS2 / VMASKBUFFERSZ_KVS) // 32 [OBSOLETE]
...
#define VPTR_SHRINK_RATIO PROCESSPARTITIONSZ // 16384 // 1, 16, 16384
...
#define MESSAGES_RETURNVALUES_SIZE 16 // 8//16
#define MESSAGES_MAILBOX_SIZE 16 // 8//16
...
#define MESSAGES_ENABLE_ACTSGP (MESSAGES_ENABLE_APPLYUPDATESCOMMAND + 1)
#define MESSAGES_ACTSCONFIG_INSERTSTATSMETADATAINEDGES (MESSAGES_ENABLE_ACTSGP + 1) // USED FOR PASSING CONFIG_INSERTSTATSMETADATAINEDGES

#define MESSAGES_BASEOFFSETKVS_MESSAGESDATA (MESSAGES_ACTSCONFIG_INSERTSTATSMETADATAINEDGES + 1)
...
#define MESSAGES_SIZE_MESSAGESDATA (MESSAGES_ACTSMESSAGE_OTHERINFOS + 1)
...
#define MESSAGES_DUMMYCHKPOINT (MESSAGES_ACTSPARAMS_EDGES_IN_SEPERATE_BUFFER_FROM_KVDRAM + 1)
#define MESSAGES_RETURNVALUES (MESSAGES_DUMMYCHKPOINT + 1)
