...
#define CONFIG_ALGORITHMTYPE_RANDOMACTIVEVERTICES
#endif 
...
#define CONFIG_ALL_EVALUATIONTYPES_IN_ONE_KERNEL // for evaluation { processedges2.cpp reduceupdates.cpp, acts.cpp, partitionupdates.cpp }
////////////////
...
#define OPT_SRAMSZ_POW 10 // 9 // 10
#define MAX_SRAMSZ_POW (((25 - NUM_PARTITIONS_POW) - NUM_PARTITIONS_POW) - NUM_PARTITIONS_POW) // KVDATA_RANGE_POW // 8192 // 13
#ifdef CONFIG_ACTS_RECURSIVEPARTITIONINGLOGIC
	#define SRAMSZ_POW OPT_SRAMSZ_POW 
#else
	#define SRAMSZ_POW MAX(MAX_SRAMSZ_POW, OPT_SRAMSZ_POW)
#endif
...
/* #ifdef ALGORITHMTYPE_REPRESENTVDATASASBITS
	...
	// #else 
	// #define PROCESSPARTITIONSZ (((((1 << OPT_SRAMSZ_POW) / NUM_PEs) / VDATA_SHRINK_RATIO) * VDATA_SHRINK_RATIO) * NUM_PEs * VDATA_PACKINGSIZE)	
	// #endif 
	#define PROCESSPARTITIONSZ (((((1 << OPT_SRAMSZ_POW) / NUM_PEs) / VDATA_SHRINK_RATIO) * VDATA_SHRINK_RATIO) * NUM_PEs * VDATA_PACKINGSIZE)	
#else 
	#ifdef CONFIG_ACTS_RECURSIVEPARTITIONINGLOGIC
	...
	#else 
	#define PROCESSPARTITIONSZ (((1 << OPT_SRAMSZ_POW) / NUM_PEs) * NUM_PEs * VDATA_PACKINGSIZE) // 16128
	#endif 
	#define PROCESSPARTITIONSZ (((1 << OPT_SRAMSZ_POW) / NUM_PEs) * NUM_PEs * VDATA_PACKINGSIZE) // 16128
#endif 	 */	
#define PROCESSPARTITIONSZ (((((1 << OPT_SRAMSZ_POW) / NUM_PEs) / VDATA_SHRINK_RATIO) * VDATA_SHRINK_RATIO) * NUM_PEs * VDATA_PACKINGSIZE)	
...
#define MESSAGES_EVALUATION_ACTS_UNUSED1 (MESSAGES_EVALUATION_ACTS_HYBRIDLOGIC + 1)
#define MESSAGES_EVALUATION_ACTS_UNUSED2 (MESSAGES_EVALUATION_ACTS_UNUSED1 + 1)
#define MESSAGES_EVALUATION_ACTS_UNUSED3 (MESSAGES_EVALUATION_ACTS_UNUSED2 + 1)

#define MESSAGES_BASEOFFSETKVS_MESSAGESDATA (MESSAGES_EVALUATION_ACTS_UNUSED3 + 1) // (MESSAGES_ACTSCONFIG_INSERTSTATSMETADATAINEDGES + 1)
