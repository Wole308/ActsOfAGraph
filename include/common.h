...
#define MESSAGES_BASEOFFSETKVS_MESSAGESDATA (MESSAGES_THRESHOLD_HYBRIDGPMODE_MAXLIMIT_ACTVEDGEBLOCKS_PER_VPARTITION + 1)
...
#define MESSAGES_BASEOFFSETKVS_ACTIVEEDGEBLOCKS (MESSAGES_BASEOFFSETKVS_DESTVERTICESDATA + 1)
...
#define MESSAGES_SIZE_ACTIVEEDGEBLOCKS (MESSAGES_SIZE_DESTVERTICESDATA + 1)
...
#define NUM_VERTICES_PER_EDGEBLOCK (NUM_PEs * EDGEDATA_PACKINGSIZE) // 384
#define MAXNUM_EDGEBLOCKS_PER_VPARTITION (((1 << MAX_PROC_SRAMSZ_POW) * VDATA_PACKINGSIZE) / NUM_VERTICES_PER_EDGEBLOCK) // 341
#define ALLIGNED_MAXNUM_EDGEBLOCKS_PER_VPARTITION (((MAXNUM_EDGEBLOCKS_PER_VPARTITION + (VECTOR_SIZE - 1)) / VECTOR_SIZE) * VECTOR_SIZE) // 344
#define MAXNUM_SPARESEVERTEXUPDATES_PER_VPARTITION 0 //64 // NOT USED

// #define POW_VERTICES_PER_UPDATEBLOCK_POW 9
// #define NUM_VERTICES_PER_UPDATEBLOCK (1 << POW_VERTICES_PER_UPDATEBLOCK_POW) // 512, or 32 in kvs
// #define NUM_UPDATEBLOCKS_PER_VPARTITION 256 // 512 
