...
#define GRAFBOOST_SETUP // ACTGRAPH_SETUP, GRAFBOOST_SETUP
...
#define NUMUTILITYTHREADS 1 // 16 // NUMCPUTHREADS // FIXME?
...
/* #if defined(ACTSMODEL)
	...
	#define MAXKVDATA_BATCHSIZE 16000000 // 12000000 // REMOVEME.
#else
    #define MAXKVDATA_BATCHSIZE (1 << 26)
#endif
