...
// #define MAXNUM_UPROPBLOCKS_PER_VPARTITION 64 // 512
...
// #define MAX_BLOCKRAM_VSRCDATA_SIZE 512 // NEWCHANGE NOW.
// #else 
...
#define SYNCPHASE_TRANSFSZ_COLLECTIONID 3
// category 2
#define NUMEDGESPROCESSED_COLLECTIONID 4
#define NUMVERTICESPROCESSED_COLLECTIONID 5
// category 3
#define NUMREADSFROMDRAM_COLLECTIONID 6
#define NUMWRITESTODRAM_COLLECTIONID 7

#define DRAM_ACCESS_LATENCY 16
#define AVERAGE_MEMACCESSTHROUGHPUT_SINGLEHBMCHANNEL_MILIONEDGESPERSEC ((23 * 1000) / 10) // ((23 / 10) * 1000) // {23M uint32 seen processed in 10ms}{10M uint32 seen processed in 4ms}
