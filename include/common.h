...
#define VDATA_PACKING_PERCHANNEL 320
#define VDATA_PACKINGNUMSETS_OFFLINE VDATA_PACKING_PERCHANNEL // 16, VDATA_PACKINGNUMSETS_OFFLINE

#define NUM_VERTICES_PER_UPROPBLOCK 64 // 256 // { 256, 64, }
#define NUM_VERTICESKVS_PER_UPROPBLOCK (NUM_VERTICES_PER_UPROPBLOCK / VDATA_PACKINGSIZE) // { 16, 4, }
#define NUM_UPROPBLOCKS_PER_VPARTITION ((VDATA_PACKING_PERCHANNEL * NUM_PEs) / NUM_VERTICESKVS_PER_UPROPBLOCK) //1920
...
#define NUM_ACTVVSPARTITIONS_PER_VPARTITION NUM_PEs // 24
...
#define REPORT__SPARSEPROCESS_SLOWDOWN_FACTOR 2
...
typedef struct {
	vdata_t data;
	// keyvalue_t acttv; // CRITICAL NEWCHANGE NOW.
	// unsigned int acttv;
} keyvalue_vbuffer_t;
