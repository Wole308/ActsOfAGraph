...
// #define MAXVSIZE_ACTVEDGEBLOCK 128 // 64, 128, 512, 1024 // NEWCHANGE. universalparams.PROC_SRAMSZ * VDATA_PACKINGSIZE
...
#endif
#define MAXVSIZE_ACTVEDGEBLOCK 128
#define MAXNUM_ACTVEDGEBLOCKS_PER_VPARTITION (((1 << MAX_PROC_SRAMSZ_POW) * VDATA_PACKINGSIZE) / MAXVSIZE_ACTVEDGEBLOCK) // 1024
