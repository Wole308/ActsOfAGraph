...
typedef struct {
	...
	unsigned int MAXHBMCAPACITY_V; // (256MB/4=64M)
	unsigned int MAXHBMCAPACITY_KV; // (256MB/8=32M)
	unsigned int MAXHBMCAPACITY_VS; // (64M/16=4M)
	unsigned int MAXHBMCAPACITY_KVS; // (32M/8=4M)
