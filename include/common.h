...
#define READVERTEXPROPMODE 5
#define SAVEVERTEXPROPMODE 5
...
#endif
// #define MAXVSIZE_ACTVEDGEBLOCK 128 // 128
// #define MAXNUM_EDGEBLOCKS_PER_VPARTITION (((1 << MAX_PROC_SRAMSZ_POW) * VDATA_PACKINGSIZE) / MAXVSIZE_ACTVEDGEBLOCK) // 1024
#define MAXVSIZE_ACTVEDGEBLOCK 384 // 128
#define MAXNUM_EDGEBLOCKS_PER_VPARTITION (((1 << MAX_PROC_SRAMSZ_POW) * VDATA_PACKINGSIZE) / MAXVSIZE_ACTVEDGEBLOCK) // 341
// #define MAXNUM_ACTVVS_PER_VPARTITION 
