...
#define APPLYVERTEXBUFFERSZ (1 << APPLYVERTEXBUFFERSZ_POW) // (1 << (BATCH_RANGE_POW - (TREE_DEPTH * NUM_PARTITIONS_POW)))
...
////////////////
	...
	#ifdef SSSP_ALGORITHM
	// #define MAXKVDATA_BATCHSIZE 6000000
	#define MAXKVDATA_BATCHSIZE 12000000 // CRITICAL FIXME.
	// #define MAXKVDATA_BATCHSIZE 15000000 // CRITICAL REMOVEME.
	#endif 
	// #define MAXKVDATA_BATCHSIZE 6000000 // ACCURACYCHECKPOINT.
	// #define MAXKVDATA_BATCHSIZE 8000000 // ACCURACYCHECKPOINT.
	// #define MAXKVDATA_BATCHSIZE 7000000
	// #define MAXKVDATA_BATCHSIZE 12000000 
#else 
	#define MAXKVDATA_BATCHSIZE 12000000
#endif 
...
#define MESSAGES_SIZE_KVSTATSSZ (MESSAGES_BASEOFFSET_VERTICESDATA_KVS + 1)
...
#define VISITED_IN_PAST_ITERATION 3//3//2 // CRITICAL FIXME?
