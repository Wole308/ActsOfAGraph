...
// #define TREE_DEPTH (((BATCH_RANGE_POW - (SRAMSZ_POW + VERTICESDATAPACKINGFACTOR_POW)) + (NUM_PARTITIONS_POW - 1)) / NUM_PARTITIONS_POW)
...
#define VISITED_IN_PAST_ITERATION 3//2 // CRITICAL FIXME?
