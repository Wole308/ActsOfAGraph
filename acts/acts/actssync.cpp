...
synchronizeandapply(bool_type enable1, bool_type enable2,  keyvalue_vbuffer_t res[VBUFFER_VECTOR_SIZE][BLOCKRAM_SIZE], keyvalue_vbuffer_t refbuffer[VBUFFER_VECTOR_SIZE][BLOCKRAM_SIZE], uintNUMPby2_type vmask[BLOCKRAM_SIZE], unsigned int colindex, batch_type voffset_kvs, globalparams_t globalparams){					
	...
	#pragma HLS PIPELINE II=1
		...
		keyvalue_t mykeyvalue0;
		mykeyvalue0.key = mergefunc(udata0.key, keyvalue0_vault0.key, globalparams.ALGORITHMINFO_GRAPHALGORITHMID);
		mykeyvalue0.value = mergefunc(udata0.value, keyvalue0_vault0.value, globalparams.ALGORITHMINFO_GRAPHALGORITHMID);
		res[0][i] = GETKV2(mykeyvalue0);
	
		keyvalue_t mykeyvalue1;
		mykeyvalue1.key = mergefunc(udata1.key, keyvalue1_vault0.key, globalparams.ALGORITHMINFO_GRAPHALGORITHMID);
		mykeyvalue1.value = mergefunc(udata1.value, keyvalue1_vault0.value, globalparams.ALGORITHMINFO_GRAPHALGORITHMID);
		res[1][i] = GETKV2(mykeyvalue1);
	
		keyvalue_t mykeyvalue2;
		mykeyvalue2.key = mergefunc(udata2.key, keyvalue2_vault0.key, globalparams.ALGORITHMINFO_GRAPHALGORITHMID);
		mykeyvalue2.value = mergefunc(udata2.value, keyvalue2_vault0.value, globalparams.ALGORITHMINFO_GRAPHALGORITHMID);
		res[2][i] = GETKV2(mykeyvalue2);
	
		keyvalue_t mykeyvalue3;
		mykeyvalue3.key = mergefunc(udata3.key, keyvalue3_vault0.key, globalparams.ALGORITHMINFO_GRAPHALGORITHMID);
		mykeyvalue3.value = mergefunc(udata3.value, keyvalue3_vault0.value, globalparams.ALGORITHMINFO_GRAPHALGORITHMID);
		res[3][i] = GETKV2(mykeyvalue3);
	
		keyvalue_t mykeyvalue4;
		mykeyvalue4.key = mergefunc(udata4.key, keyvalue4_vault0.key, globalparams.ALGORITHMINFO_GRAPHALGORITHMID);
		mykeyvalue4.value = mergefunc(udata4.value, keyvalue4_vault0.value, globalparams.ALGORITHMINFO_GRAPHALGORITHMID);
		res[4][i] = GETKV2(mykeyvalue4);
	
		keyvalue_t mykeyvalue5;
		mykeyvalue5.key = mergefunc(udata5.key, keyvalue5_vault0.key, globalparams.ALGORITHMINFO_GRAPHALGORITHMID);
		mykeyvalue5.value = mergefunc(udata5.value, keyvalue5_vault0.value, globalparams.ALGORITHMINFO_GRAPHALGORITHMID);
		res[5][i] = GETKV2(mykeyvalue5);
	
		keyvalue_t mykeyvalue6;
		mykeyvalue6.key = mergefunc(udata6.key, keyvalue6_vault0.key, globalparams.ALGORITHMINFO_GRAPHALGORITHMID);
		mykeyvalue6.value = mergefunc(udata6.value, keyvalue6_vault0.value, globalparams.ALGORITHMINFO_GRAPHALGORITHMID);
		res[6][i] = GETKV2(mykeyvalue6);
	
		keyvalue_t mykeyvalue7;
		mykeyvalue7.key = mergefunc(udata7.key, keyvalue7_vault0.key, globalparams.ALGORITHMINFO_GRAPHALGORITHMID);
		mykeyvalue7.value = mergefunc(udata7.value, keyvalue7_vault0.value, globalparams.ALGORITHMINFO_GRAPHALGORITHMID);
