...
#include "/home/oj2zf/Documents/ActsOfAFastGraph/include/common.h"
#include <string>
#include <string.h>
#include <iostream>
#include <vector>
...
#include <fstream>
#ifndef FPGA_IMPL
#include "/home/oj2zf/Documents/ActsOfAFastGraph/acts/actsutility/actsutility.h"
#endif 
#include "/home/oj2zf/Documents/ActsOfAFastGraph/acts/acts/acts.h"
using namespace std;
...
void acts::collectstats00(unsigned int enable, unsigned int workerID , uint512_dt sourcebuffer0[SRCBUFFER_SIZE] , keyvalue_t capsule0[NUM_PARTITIONS], clopparams_t llopparams, travstate_t travstate){
	if(enable == 0){ return; }
...
#endif
void acts::partitionkeyvalues00(unsigned int enable, unsigned int workerID , uint512_dt sourcebuffer0[SRCBUFFER_SIZE] , uint512_dt destbuffer0[PADDEDDESTBUFFER_SIZE] , keyvalue_t capsule0[NUM_PARTITIONS], travstate_t travstate, clopparams_t llopparams){					
	if(enable == 0){ return; }
