...
public:
	...
	value_t applyfunc(value_t value1, value_t value2, unsigned int GraphAlgo);
	globalparams_t SYNC_getglobalparams(uint512_dt * kvdram);

	void topkernelapply(uint512_dt * kvdram0, uint512_dt * kvdram1, uint512_dt * kvdram2, uint512_dt * kvdram3);
