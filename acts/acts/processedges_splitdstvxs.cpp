...
PROCESS_readandprocess(bool_type enable, uint512_dt * edges, uint512_dt * kvdram, keyvalue_vbuffer_t vbuffer[VDATA_PACKINGSIZE][BLOCKRAM_SIZE], unit1_type vmaskBITS[VMASK_PACKINGSIZE][DOUBLE_BLOCKRAM_SIZE], unit1_type vmask_subp[VMASK_PACKINGSIZE][DOUBLE_BLOCKRAM_SIZE], keyvalue_buffer_t buffer[VECTOR_SIZE][SOURCEBLOCKRAM_SIZE], 
 ...
 // AUTOMATEME. OPTIMIZEME. FIXME.BOTTLENECK
		...
		bool_type ens15 = ON; if(E[15] == INVALIDDATA || lsrcvids15 >= validbound){ ens15 = OFF; }
			#ifdef _DEBUGMODE_KERNELPRINTS
			cout<<"readandprocess(3): E[0]: "<<E[0]<<", lvid_head: "<<lvid_head<<", incr0: "<<incr0<<", lsrcvids0: "<<lsrcvids0<<", ens0: "<<ens0<<endl;
			cout<<"readandprocess(3): E[1]: "<<E[1]<<", lvid_head: "<<lvid_head<<", incr1: "<<incr1<<", lsrcvids1: "<<lsrcvids1<<", ens1: "<<ens1<<endl;
			cout<<"readandprocess(3): E[2]: "<<E[2]<<", lvid_head: "<<lvid_head<<", incr2: "<<incr2<<", lsrcvids2: "<<lsrcvids2<<", ens2: "<<ens2<<endl;
			cout<<"readandprocess(3): E[3]: "<<E[3]<<", lvid_head: "<<lvid_head<<", incr3: "<<incr3<<", lsrcvids3: "<<lsrcvids3<<", ens3: "<<ens3<<endl;
			cout<<"readandprocess(3): E[4]: "<<E[4]<<", lvid_head: "<<lvid_head<<", incr4: "<<incr4<<", lsrcvids4: "<<lsrcvids4<<", ens4: "<<ens4<<endl;
			cout<<"readandprocess(3): E[5]: "<<E[5]<<", lvid_head: "<<lvid_head<<", incr5: "<<incr5<<", lsrcvids5: "<<lsrcvids5<<", ens5: "<<ens5<<endl;
			cout<<"readandprocess(3): E[6]: "<<E[6]<<", lvid_head: "<<lvid_head<<", incr6: "<<incr6<<", lsrcvids6: "<<lsrcvids6<<", ens6: "<<ens6<<endl;
			cout<<"readandprocess(3): E[7]: "<<E[7]<<", lvid_head: "<<lvid_head<<", incr7: "<<incr7<<", lsrcvids7: "<<lsrcvids7<<", ens7: "<<ens7<<endl;
			cout<<"readandprocess(3): E[8]: "<<E[8]<<", lvid_head: "<<lvid_head<<", incr8: "<<incr8<<", lsrcvids8: "<<lsrcvids8<<", ens8: "<<ens8<<endl;
			cout<<"readandprocess(3): E[9]: "<<E[9]<<", lvid_head: "<<lvid_head<<", incr9: "<<incr9<<", lsrcvids9: "<<lsrcvids9<<", ens9: "<<ens9<<endl;
			cout<<"readandprocess(3): E[10]: "<<E[10]<<", lvid_head: "<<lvid_head<<", incr10: "<<incr10<<", lsrcvids10: "<<lsrcvids10<<", ens10: "<<ens10<<endl;
			cout<<"readandprocess(3): E[11]: "<<E[11]<<", lvid_head: "<<lvid_head<<", incr11: "<<incr11<<", lsrcvids11: "<<lsrcvids11<<", ens11: "<<ens11<<endl;
			cout<<"readandprocess(3): E[12]: "<<E[12]<<", lvid_head: "<<lvid_head<<", incr12: "<<incr12<<", lsrcvids12: "<<lsrcvids12<<", ens12: "<<ens12<<endl;
			cout<<"readandprocess(3): E[13]: "<<E[13]<<", lvid_head: "<<lvid_head<<", incr13: "<<incr13<<", lsrcvids13: "<<lsrcvids13<<", ens13: "<<ens13<<endl;
			cout<<"readandprocess(3): E[14]: "<<E[14]<<", lvid_head: "<<lvid_head<<", incr14: "<<incr14<<", lsrcvids14: "<<lsrcvids14<<", ens14: "<<ens14<<endl;
			cout<<"readandprocess(3): E[15]: "<<E[15]<<", lvid_head: "<<lvid_head<<", incr15: "<<incr15<<", lsrcvids15: "<<lsrcvids15<<", ens15: "<<ens15<<endl;
			#endif
			#ifdef _DEBUGMODE_CHECKS2
 ...
 cout<<">>> readandprocess(14).mask: E[0]: "<<E[0]<<", lvid_head: "<<lvid_head<<", lsrcvids0: "<<lsrcvids0<<", ldstvids0: "<<ldstvids0<<", incr0: "<<incr0<<endl;  cout<<">>> readandprocess(14).mask: E[1]: "<<E[1]<<", lvid_head: "<<lvid_head<<", lsrcvids1: "<<lsrcvids1<<", ldstvids1: "<<ldstvids1<<", incr1: "<<incr1<<endl;  cout<<">>> readandprocess(14).mask: E[2]: "<<E[2]<<", lvid_head: "<<lvid_head<<", lsrcvids2: "<<lsrcvids2<<", ldstvids2: "<<ldstvids2<<", incr2: "<<incr2<<endl;  cout<<">>> readandprocess(14).mask: E[3]: "<<E[3]<<", lvid_head: "<<lvid_head<<", lsrcvids3: "<<lsrcvids3<<", ldstvids3: "<<ldstvids3<<", incr3: "<<incr3<<endl;  cout<<">>> readandprocess(14).mask: E[4]: "<<E[4]<<", lvid_head: "<<lvid_head<<", lsrcvids4: "<<lsrcvids4<<", ldstvids4: "<<ldstvids4<<", incr4: "<<incr4<<endl;  cout<<">>> readandprocess(14).mask: E[5]: "<<E[5]<<", lvid_head: "<<lvid_head<<", lsrcvids5: "<<lsrcvids5<<", ldstvids5: "<<ldstvids5<<", incr5: "<<incr5<<endl;  cout<<">>> readandprocess(14).mask: E[6]: "<<E[6]<<", lvid_head: "<<lvid_head<<", lsrcvids6: "<<lsrcvids6<<", ldstvids6: "<<ldstvids6<<", incr6: "<<incr6<<endl;  cout<<">>> readandprocess(14).mask: E[7]: "<<E[7]<<", lvid_head: "<<lvid_head<<", lsrcvids7: "<<lsrcvids7<<", ldstvids7: "<<ldstvids7<<", incr7: "<<incr7<<endl;  cout<<">>> readandprocess(14).mask: E[8]: "<<E[8]<<", lvid_head: "<<lvid_head<<", lsrcvids8: "<<lsrcvids8<<", ldstvids8: "<<ldstvids8<<", incr8: "<<incr8<<endl;  cout<<">>> readandprocess(14).mask: E[9]: "<<E[9]<<", lvid_head: "<<lvid_head<<", lsrcvids9: "<<lsrcvids9<<", ldstvids9: "<<ldstvids9<<", incr9: "<<incr9<<endl;  cout<<">>> readandprocess(14).mask: E[10]: "<<E[10]<<", lvid_head: "<<lvid_head<<", lsrcvids10: "<<lsrcvids10<<", ldstvids10: "<<ldstvids10<<", incr10: "<<incr10<<endl;  cout<<">>> readandprocess(14).mask: E[11]: "<<E[11]<<", lvid_head: "<<lvid_head<<", lsrcvids11: "<<lsrcvids11<<", ldstvids11: "<<ldstvids11<<", incr11: "<<incr11<<endl;  cout<<">>> readandprocess(14).mask: E[12]: "<<E[12]<<", lvid_head: "<<lvid_head<<", lsrcvids12: "<<lsrcvids12<<", ldstvids12: "<<ldstvids12<<", incr12: "<<incr12<<endl;  cout<<">>> readandprocess(14).mask: E[13]: "<<E[13]<<", lvid_head: "<<lvid_head<<", lsrcvids13: "<<lsrcvids13<<", ldstvids13: "<<ldstvids13<<", incr13: "<<incr13<<endl;  cout<<">>> readandprocess(14).mask: E[14]: "<<E[14]<<", lvid_head: "<<lvid_head<<", lsrcvids14: "<<lsrcvids14<<", ldstvids14: "<<ldstvids14<<", incr14: "<<incr14<<endl;  cout<<">>> readandprocess(14).mask: E[15]: "<<E[15]<<", lvid_head: "<<lvid_head<<", lsrcvids15: "<<lsrcvids15<<", ldstvids15: "<<ldstvids15<<", incr15: "<<incr15<<endl;  
		...
		value_t res0 = PROCESS_processfunc(ludatas[incr0], 1, globalparams.ALGORITHMINFO_GRAPHALGORITHMID); 
		value_t res1 = PROCESS_processfunc(ludatas[incr1], 1, globalparams.ALGORITHMINFO_GRAPHALGORITHMID); 
		value_t res2 = PROCESS_processfunc(ludatas[incr2], 1, globalparams.ALGORITHMINFO_GRAPHALGORITHMID); 
		value_t res3 = PROCESS_processfunc(ludatas[incr3], 1, globalparams.ALGORITHMINFO_GRAPHALGORITHMID); 
		value_t res4 = PROCESS_processfunc(ludatas[incr4], 1, globalparams.ALGORITHMINFO_GRAPHALGORITHMID); 
		value_t res5 = PROCESS_processfunc(ludatas[incr5], 1, globalparams.ALGORITHMINFO_GRAPHALGORITHMID); 
		value_t res6 = PROCESS_processfunc(ludatas[incr6], 1, globalparams.ALGORITHMINFO_GRAPHALGORITHMID); 
		value_t res7 = PROCESS_processfunc(ludatas[incr7], 1, globalparams.ALGORITHMINFO_GRAPHALGORITHMID); 
		value_t res8 = PROCESS_processfunc(ludatas[incr8], 1, globalparams.ALGORITHMINFO_GRAPHALGORITHMID); 
		value_t res9 = PROCESS_processfunc(ludatas[incr9], 1, globalparams.ALGORITHMINFO_GRAPHALGORITHMID); 
		value_t res10 = PROCESS_processfunc(ludatas[incr10], 1, globalparams.ALGORITHMINFO_GRAPHALGORITHMID); 
		value_t res11 = PROCESS_processfunc(ludatas[incr11], 1, globalparams.ALGORITHMINFO_GRAPHALGORITHMID); 
		value_t res12 = PROCESS_processfunc(ludatas[incr12], 1, globalparams.ALGORITHMINFO_GRAPHALGORITHMID); 
		value_t res13 = PROCESS_processfunc(ludatas[incr13], 1, globalparams.ALGORITHMINFO_GRAPHALGORITHMID); 
		value_t res14 = PROCESS_processfunc(ludatas[incr14], 1, globalparams.ALGORITHMINFO_GRAPHALGORITHMID); 
		value_t res15 = PROCESS_processfunc(ludatas[incr15], 1, globalparams.ALGORITHMINFO_GRAPHALGORITHMID); 
		...
		mykeyvalue0.value = INVALIDDATA;
			...
			if(ens0 == ON && mask0 == 1){ cout<<"readandprocess(15): [i: "<<i<<", lsrcvids0: "<<lsrcvids0<<", ldstvids0: "<<ldstvids0<<", udata: "<<ludatas[incr0]<<"], [ens0: "<<ens0<<", mask0: "<<mask0<<"]. sweepparams.source_partition: "<<sweepparams.source_partition<<endl; }			
			if(ens1 == ON && mask1 == 1){ cout<<"readandprocess(15): [i: "<<i<<", lsrcvids1: "<<lsrcvids1<<", ldstvids1: "<<ldstvids1<<", udata: "<<ludatas[incr1]<<"], [ens1: "<<ens1<<", mask1: "<<mask1<<"]. sweepparams.source_partition: "<<sweepparams.source_partition<<endl; }			
			if(ens2 == ON && mask2 == 1){ cout<<"readandprocess(15): [i: "<<i<<", lsrcvids2: "<<lsrcvids2<<", ldstvids2: "<<ldstvids2<<", udata: "<<ludatas[incr2]<<"], [ens2: "<<ens2<<", mask2: "<<mask2<<"]. sweepparams.source_partition: "<<sweepparams.source_partition<<endl; }			
			if(ens3 == ON && mask3 == 1){ cout<<"readandprocess(15): [i: "<<i<<", lsrcvids3: "<<lsrcvids3<<", ldstvids3: "<<ldstvids3<<", udata: "<<ludatas[incr3]<<"], [ens3: "<<ens3<<", mask3: "<<mask3<<"]. sweepparams.source_partition: "<<sweepparams.source_partition<<endl; }			
			if(ens4 == ON && mask4 == 1){ cout<<"readandprocess(15): [i: "<<i<<", lsrcvids4: "<<lsrcvids4<<", ldstvids4: "<<ldstvids4<<", udata: "<<ludatas[incr4]<<"], [ens4: "<<ens4<<", mask4: "<<mask4<<"]. sweepparams.source_partition: "<<sweepparams.source_partition<<endl; }			
			if(ens5 == ON && mask5 == 1){ cout<<"readandprocess(15): [i: "<<i<<", lsrcvids5: "<<lsrcvids5<<", ldstvids5: "<<ldstvids5<<", udata: "<<ludatas[incr5]<<"], [ens5: "<<ens5<<", mask5: "<<mask5<<"]. sweepparams.source_partition: "<<sweepparams.source_partition<<endl; }			
			if(ens6 == ON && mask6 == 1){ cout<<"readandprocess(15): [i: "<<i<<", lsrcvids6: "<<lsrcvids6<<", ldstvids6: "<<ldstvids6<<", udata: "<<ludatas[incr6]<<"], [ens6: "<<ens6<<", mask6: "<<mask6<<"]. sweepparams.source_partition: "<<sweepparams.source_partition<<endl; }			
			if(ens7 == ON && mask7 == 1){ cout<<"readandprocess(15): [i: "<<i<<", lsrcvids7: "<<lsrcvids7<<", ldstvids7: "<<ldstvids7<<", udata: "<<ludatas[incr7]<<"], [ens7: "<<ens7<<", mask7: "<<mask7<<"]. sweepparams.source_partition: "<<sweepparams.source_partition<<endl; }			
			if(ens8 == ON && mask8 == 1){ cout<<"readandprocess(15): [i: "<<i<<", lsrcvids8: "<<lsrcvids8<<", ldstvids8: "<<ldstvids8<<", udata: "<<ludatas[incr8]<<"], [ens8: "<<ens8<<", mask8: "<<mask8<<"]. sweepparams.source_partition: "<<sweepparams.source_partition<<endl; }			
			if(ens9 == ON && mask9 == 1){ cout<<"readandprocess(15): [i: "<<i<<", lsrcvids9: "<<lsrcvids9<<", ldstvids9: "<<ldstvids9<<", udata: "<<ludatas[incr9]<<"], [ens9: "<<ens9<<", mask9: "<<mask9<<"]. sweepparams.source_partition: "<<sweepparams.source_partition<<endl; }			
			if(ens10 == ON && mask10 == 1){ cout<<"readandprocess(15): [i: "<<i<<", lsrcvids10: "<<lsrcvids10<<", ldstvids10: "<<ldstvids10<<", udata: "<<ludatas[incr10]<<"], [ens10: "<<ens10<<", mask10: "<<mask10<<"]. sweepparams.source_partition: "<<sweepparams.source_partition<<endl; }			
			if(ens11 == ON && mask11 == 1){ cout<<"readandprocess(15): [i: "<<i<<", lsrcvids11: "<<lsrcvids11<<", ldstvids11: "<<ldstvids11<<", udata: "<<ludatas[incr11]<<"], [ens11: "<<ens11<<", mask11: "<<mask11<<"]. sweepparams.source_partition: "<<sweepparams.source_partition<<endl; }			
			if(ens12 == ON && mask12 == 1){ cout<<"readandprocess(15): [i: "<<i<<", lsrcvids12: "<<lsrcvids12<<", ldstvids12: "<<ldstvids12<<", udata: "<<ludatas[incr12]<<"], [ens12: "<<ens12<<", mask12: "<<mask12<<"]. sweepparams.source_partition: "<<sweepparams.source_partition<<endl; }			
			if(ens13 == ON && mask13 == 1){ cout<<"readandprocess(15): [i: "<<i<<", lsrcvids13: "<<lsrcvids13<<", ldstvids13: "<<ldstvids13<<", udata: "<<ludatas[incr13]<<"], [ens13: "<<ens13<<", mask13: "<<mask13<<"]. sweepparams.source_partition: "<<sweepparams.source_partition<<endl; }			
			if(ens14 == ON && mask14 == 1){ cout<<"readandprocess(15): [i: "<<i<<", lsrcvids14: "<<lsrcvids14<<", ldstvids14: "<<ldstvids14<<", udata: "<<ludatas[incr14]<<"], [ens14: "<<ens14<<", mask14: "<<mask14<<"]. sweepparams.source_partition: "<<sweepparams.source_partition<<endl; }			
			if(ens15 == ON && mask15 == 1){ cout<<"readandprocess(15): [i: "<<i<<", lsrcvids15: "<<lsrcvids15<<", ldstvids15: "<<ldstvids15<<", udata: "<<ludatas[incr15]<<"], [ens15: "<<ens15<<", mask15: "<<mask15<<"]. sweepparams.source_partition: "<<sweepparams.source_partition<<endl; }			
			#endif
