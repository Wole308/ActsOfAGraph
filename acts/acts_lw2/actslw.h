...
public:
	...
	void readglobalstats0(unsigned int enable, uint512_dt * kvdram1, uint512_dt * kvdram2, keyvalue_t globalstatsbuffer[PADDEDDESTBUFFER_SIZE], keyvalue_t buffer[NUM_PARTITIONS], unsigned int offset_kvs, unsigned int currentLOP, unsigned int sourceORdest);
	
	void saveglobalstats0(unsigned int enable, uint512_dt * kvdram1, uint512_dt * kvdram2, keyvalue_t globalstatsbuffer[PADDEDDESTBUFFER_SIZE], keyvalue_t buffer[16][PADDEDDESTBUFFER_SIZE]);
	
	void updateglobalstats0(unsigned int enable, uint512_dt * kvdram, keyvalue_t globalstatsbuffer[PADDEDDESTBUFFER_SIZE], keyvalue_t buffer[NUM_PARTITIONS], unsigned int offset_kvs, unsigned int currentLOP, unsigned int sourceORdest);
	
	void prepareglobalstats0(unsigned int enable, uint512_dt * kvdram);
	
	void readkeyvalues0(unsigned int enable, uint512_dt * kvdram1, uint512_dt * kvdram2, keyvalue_t buffer[16][SRCBUFFER_SIZE], batch_type offset_kvs, travstate_t travstate);
	
	void readvertices0(unsigned int enable, uint512_dt * kvdram1, uint512_dt * kvdram2, keyvalue_t buffer[VECTOR_SIZE][PADDEDDESTBUFFER_SIZE], batch_type offset_kvs);
	
	void savekeyvalues0(unsigned int enable, uint512_dt * kvdram1, uint512_dt * kvdram2, uint1024_dt buffer[PADDEDDESTBUFFER_SIZE], keyvalue_t * globalcapsule, keyvalue_t localcapsule[NUM_PARTITIONS], batch_type globalbaseaddress_kvs);
	
	void savevertices0(unsigned int enable, uint512_dt * kvdram1, uint512_dt * kvdram2, keyvalue_t buffer[VECTOR_SIZE][PADDEDDESTBUFFER_SIZE], batch_type offset_kvs);
	
	void collectglobalstats0(unsigned int enable, keyvalue_t sourcebuffer[16][SRCBUFFER_SIZE], keyvalue_t destbuffer[16][PADDEDDESTBUFFER_SIZE], unsigned int upperlimit);
	
	void prepareglobalstats0(unsigned int enable, keyvalue_t buffer[VECTOR_SIZE][PADDEDDESTBUFFER_SIZE]);
	
	void partitionkeyvalues0(unsigned int enable, keyvalue_t sourcebuffer[16][SRCBUFFER_SIZE], keyvalue_t destbuffer[16][PADDEDDESTBUFFER_SIZE], keyvalue_t localcapsule[16][NUM_PARTITIONS], unsigned int currentLOP, unsigned int upperlimit, travstate_t travstate);
	
	void reduce0(unsigned int enable, keyvalue_t sourcebuffer[VECTOR_SIZE][SRCBUFFER_SIZE], keyvalue_t destbuffer[VECTOR_SIZE][PADDEDDESTBUFFER_SIZE], unsigned int upperlimit, unsigned int GraphIter, unsigned int GraphAlgo, travstate_t travstate);
	...
	void combineSetof1stoSetof40_I0(unsigned int enable, keyvalue_t buffer_setof1M[PADDEDDESTBUFFER_SIZE], keyvalue_t buffer_setof1N[PADDEDDESTBUFFER_SIZE], keyvalue_t buffer_setof1O[PADDEDDESTBUFFER_SIZE], keyvalue_t buffer_setof1P[PADDEDDESTBUFFER_SIZE], uint256_dt buffer_setof4[PADDEDDESTBUFFER_SIZE], keyvalue_t localcapsuleM[NUM_PARTITIONS], keyvalue_t localcapsuleN[NUM_PARTITIONS], keyvalue_t localcapsuleO[NUM_PARTITIONS], keyvalue_t localcapsuleP[NUM_PARTITIONS], keyvalue_t localcapsuleR[NUM_PARTITIONS]);
	void combineSetof1stoSetof40_I1(unsigned int enable, keyvalue_t buffer_setof1M[PADDEDDESTBUFFER_SIZE], keyvalue_t buffer_setof1N[PADDEDDESTBUFFER_SIZE], keyvalue_t buffer_setof1O[PADDEDDESTBUFFER_SIZE], keyvalue_t buffer_setof1P[PADDEDDESTBUFFER_SIZE], uint256_dt buffer_setof4[PADDEDDESTBUFFER_SIZE], keyvalue_t localcapsuleM[NUM_PARTITIONS], keyvalue_t localcapsuleN[NUM_PARTITIONS], keyvalue_t localcapsuleO[NUM_PARTITIONS], keyvalue_t localcapsuleP[NUM_PARTITIONS], keyvalue_t localcapsuleR[NUM_PARTITIONS]);
	void combineSetof1stoSetof40_I2(unsigned int enable, keyvalue_t buffer_setof1M[PADDEDDESTBUFFER_SIZE], keyvalue_t buffer_setof1N[PADDEDDESTBUFFER_SIZE], keyvalue_t buffer_setof1O[PADDEDDESTBUFFER_SIZE], keyvalue_t buffer_setof1P[PADDEDDESTBUFFER_SIZE], uint256_dt buffer_setof4[PADDEDDESTBUFFER_SIZE], keyvalue_t localcapsuleM[NUM_PARTITIONS], keyvalue_t localcapsuleN[NUM_PARTITIONS], keyvalue_t localcapsuleO[NUM_PARTITIONS], keyvalue_t localcapsuleP[NUM_PARTITIONS], keyvalue_t localcapsuleR[NUM_PARTITIONS]);
	void combineSetof1stoSetof40_I3(unsigned int enable, keyvalue_t buffer_setof1M[PADDEDDESTBUFFER_SIZE], keyvalue_t buffer_setof1N[PADDEDDESTBUFFER_SIZE], keyvalue_t buffer_setof1O[PADDEDDESTBUFFER_SIZE], keyvalue_t buffer_setof1P[PADDEDDESTBUFFER_SIZE], uint256_dt buffer_setof4[PADDEDDESTBUFFER_SIZE], keyvalue_t localcapsuleM[NUM_PARTITIONS], keyvalue_t localcapsuleN[NUM_PARTITIONS], keyvalue_t localcapsuleO[NUM_PARTITIONS], keyvalue_t localcapsuleP[NUM_PARTITIONS], keyvalue_t localcapsuleR[NUM_PARTITIONS]);
	void combineSetof4stoSetof160_I0(unsigned int enable, uint256_dt buffer_setof4M[PADDEDDESTBUFFER_SIZE], uint256_dt buffer_setof4N[PADDEDDESTBUFFER_SIZE], uint256_dt buffer_setof4O[PADDEDDESTBUFFER_SIZE], uint256_dt buffer_setof4P[PADDEDDESTBUFFER_SIZE], uint1024_dt buffer_setof16[PADDEDDESTBUFFER_SIZE], keyvalue_t localcapsule4M[NUM_PARTITIONS], keyvalue_t localcapsule4N[NUM_PARTITIONS], keyvalue_t localcapsule4O[NUM_PARTITIONS], keyvalue_t localcapsule4P[NUM_PARTITIONS], keyvalue_t localcapsuleR[NUM_PARTITIONS]);				
	
	// group functions
	void combineSetof1stoSetof2s0(unsigned int enable, keyvalue_t buffer_setof1[8][PADDEDDESTBUFFER_SIZE], uint128_dt buffer_setof2[4][PADDEDDESTBUFFER_SIZE], keyvalue_t templocalcapsule_so1[8][NUM_PARTITIONS], keyvalue_t templocalcapsule_so2[4][NUM_PARTITIONS]);
	void combineSetof2stoSetof4s0(unsigned int enable, uint128_dt buffer_setof2[4][PADDEDDESTBUFFER_SIZE], uint256_dt buffer_setof4[2][PADDEDDESTBUFFER_SIZE], keyvalue_t templocalcapsule_so2[4][NUM_PARTITIONS], keyvalue_t templocalcapsule_so4[2][NUM_PARTITIONS]);
	void combineSetof4stoSetof8s0(unsigned int enable, uint256_dt buffer_setof4[2][PADDEDDESTBUFFER_SIZE], uint512_dt destbuffer[PADDEDDESTBUFFER_SIZE], keyvalue_t templocalcapsule_so4[2][NUM_PARTITIONS], keyvalue_t templocalcapsule_so8[NUM_PARTITIONS]);
	
	void combineSetof1stoSetof4s0(unsigned int enable, keyvalue_t buffer_setof1[16][PADDEDDESTBUFFER_SIZE], uint256_dt buffer_setof4[4][PADDEDDESTBUFFER_SIZE], keyvalue_t templocalcapsule_so1[16][NUM_PARTITIONS], keyvalue_t templocalcapsule_so4[4][NUM_PARTITIONS]);
	void combineSetof4stoSetof16s0(unsigned int enable, uint256_dt buffer_setof4[4][PADDEDDESTBUFFER_SIZE], uint1024_dt buffer_setof16[PADDEDDESTBUFFER_SIZE], keyvalue_t templocalcapsule_so4[4][NUM_PARTITIONS], keyvalue_t templocalcapsule_so16[NUM_PARTITIONS]);
	
	void dispatch0(uint512_dt * kvdram1, uint512_dt * kvdram2);
	
	void topkernel( uint512_dt * sourceAvolume0, uint512_dt * sourceAvolume1 );
