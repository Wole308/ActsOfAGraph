...
#define OPTIMALSIZE (PADDEDDESTBUFFER_SIZE / NUM_PARTITIONS) // used with ENABLE_APPROXIMATEPARTITIONWRITES 
	...
	#define PADSKIP ((PADDEDDESTBUFFER_SIZE * 1 * 1) / (2 * 64))
#endif
...
// #define KVDRAMSZ ((DRAMBATCHFACTOR * MAXKVDATA_BATCHSIZE) + KVDRAMPADDING)
#define KVDRAMSZ (MAXKVDATA_BATCHSIZE + KVDRAMPADDING) // NEWCHANGE.
