...
// #define SRCBUFFER_SIZE (PADDEDDESTBUFFER_SIZE - NUM_PARTITIONS) // FIXME
#define SRCBUFFER_SIZE (PADDEDDESTBUFFER_SIZE - ((4 * 3 * NUM_PARTITIONS) / VECTOR_SIZE)) // FIXME
// #define SRCBUFFER_SIZE (PADDEDDESTBUFFER_SIZE - 16) // FIXME
...
// #define KVSTATSDRAMSZ (VECTOR_SIZE + (NUMLASTLEVELPARTITIONS * TREE_DEPTH)) 
...
#define KVSOURCEDRAMSZ (MESSAGESDRAMSZ + KVDRAMBUFFERSZ + KVDRAMSZ + KVDRAMWORKSPACESZ + KVSTATSDRAMSZ + MYBATCH_RANGE) // BATCH_RANGE
