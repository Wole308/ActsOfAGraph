...
// #define KVDRAMPADDING ((KVDATA_BATCHSIZE_KVS / SRCBUFFER_SIZE) * (NUM_PARTITIONS * VECTOR_SIZE)) // REMOVEME. OBSOLETE
#define KVDRAMPADDING ((KVDATA_BATCHSIZE_KVS / SRCBUFFER_SIZE) * (NUM_PARTITIONS * VECTOR_SIZE * 2) * 2)
// #define KVDRAMPADDING ((KVDATA_BATCHSIZE_KVS / SRCBUFFER_SIZE) * (4 * 3 * NUM_PARTITIONS * VECTOR_SIZE))
...
// #define KVSOURCEDRAMSZ (MESSAGESDRAMSZ + KVDRAMBUFFERSZ + KVDRAMSZ + KVDRAMWORKSPACESZ + KVSTATSDRAMSZ + MYBATCH_RANGE) // REMOVEME. OBSOLETE.	
