...
#ifdef INMEMORYGP
#define VERTICESSZ (KVDATA_RANGE + (SRCBUFFER_SIZE * VECTOR_SIZE)) // in-memory
#else 
#define VERTICESSZ ((BATCH_RANGE / 2) + (SRCBUFFER_SIZE * VECTOR_SIZE))
#endif 

// #define KVSOURCEDRAMSZ (MESSAGESDRAMSZ + KVDRAMBUFFERSZ + KVDRAMSZ + KVDRAMWORKSPACESZ + KVSTATSDRAMSZ + EDGESSZ + (BATCH_RANGE / 2))
#define KVSOURCEDRAMSZ (MESSAGESDRAMSZ + KVDRAMBUFFERSZ + KVDRAMSZ + KVDRAMWORKSPACESZ + KVSTATSDRAMSZ + EDGESSZ + VERTICESSZ)
...
#define BASEOFFSET_VERTICESDATA (BASEOFFSET_EDGESDATA + EDGESSZ) 
