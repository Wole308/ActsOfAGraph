...
#define KVDRAMPADDING ((KVDATA_BATCHSIZE_KVS / SRCBUFFER_SIZE) * (NUM_PARTITIONS * VECTOR_SIZE))
...
// #define KVSTATSDRAMSZ ((((NUMLASTLEVELPARTITIONS + (PADDEDDESTBUFFER_SIZE - 1)) / PADDEDDESTBUFFER_SIZE) * PADDEDDESTBUFFER_SIZE) * VECTOR_SIZE)
#define KVSTATSDRAMSZ (NUMLASTLEVELPARTITIONS * (TREE_DEPTH + 1) * VECTOR_SIZE) // REMOVEME? // TREE_DEPTH
#define KVSTATSDRAMSZ_KVS KVSTATSDRAMSZ

#define MYBATCH_RANGE (BATCH_RANGE * VECTOR_SIZE)
// #define MYBATCH_RANGE (BATCH_RANGE / 2) // REMOVEME.

#define MYBATCH_RANGE2 (BATCH_RANGE2 * VECTOR_SIZE)

#define KVSOURCEDRAMSZ (MESSAGESDRAMSZ + KVDRAMBUFFERSZ + KVDRAMSZ + KVDRAMWORKSPACESZ + KVSTATSDRAMSZ + MYBATCH_RANGE)
...
// #define INPUTDATASZ (MESSAGESDRAMSZ + KVDRAMBUFFERSZ + KVDRAMSZ) 
#define INPUTDATASZ PADDEDKVSOURCEDRAMSZ // REMOVEME.
