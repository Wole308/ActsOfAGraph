...
#define KVSOURCEDRAMSZ (MESSAGESDRAMSZ + KVDRAMBUFFERSZ + KVDRAMSZ + KVDRAMWORKSPACESZ + KVSTATSDRAMSZ + EDGESSZ + VERTEXPTRSSZ)						
#define VDRAMSZ (MESSAGESDRAMSZ + ACTIVEVERTICESSZ + VERTICESDATASZ)	
...
#define BASEOFFSET_STATSDRAM_KVS (BASEOFFSET_STATSDRAM / VECTOR_SIZE)
	...
	#define BASEOFFSET_ACTIVEVERTICES_KVS (BASEOFFSET_ACTIVEVERTICES / VECTOR_SIZE)
		...
		#define BASEOFFSET_EDGESDATA BASEOFFSET_KVDRAM
		#define BASEOFFSET_EDGESDATA_KVS (BASEOFFSET_EDGESDATA / VECTOR_SIZE)

		#define BASEOFFSET_VERTEXPTR (BASEOFFSET_ACTIVEVERTICES + ACTIVEVERTICESSZ) 
		#define BASEOFFSET_VERTEXPTR_KVS (BASEOFFSET_VERTEXPTR / VECTOR_SIZE)
	#else 
		#ifdef MERGEEDGESANDKVDRAMWORKSPACE
			#define BASEOFFSET_EDGESDATA BASEOFFSET_KVDRAMWORKSPACE
			#define BASEOFFSET_EDGESDATA_KVS (BASEOFFSET_EDGESDATA / VECTOR_SIZE)
	...
	// kvsource
		...
		#define BASEOFFSET_VERTEXPTR (BASEOFFSET_STATSDRAM + KVSTATSDRAMSZ) 
		#define BASEOFFSET_VERTEXPTR_KVS (BASEOFFSET_VERTEXPTR / VECTOR_SIZE)
	#else 
		#ifdef MERGEEDGESANDKVDRAMWORKSPACE
			#define BASEOFFSET_EDGESDATA BASEOFFSET_KVDRAMWORKSPACE
	...
	// vdram
	#define BASEOFFSET_ACTIVEVERTICES (BASEOFFSET_MESSAGESDRAM + MESSAGESDRAMSZ)
	#define BASEOFFSET_ACTIVEVERTICES_KVS (BASEOFFSET_ACTIVEVERTICES / VECTOR_SIZE)

	#define BASEOFFSET_VERTICESDATA (BASEOFFSET_ACTIVEVERTICES + ACTIVEVERTICESSZ) 
	#define BASEOFFSET_VERTICESDATA_KVS (BASEOFFSET_VERTICESDATA / VECTOR_SIZE)
#endif 
