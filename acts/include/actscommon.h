...
// edges workload area
#define EDGESSZ (MAXKVDATA_BATCHSIZE / NUMINTSINKEYVALUETYPE) // CRITICAL FIXME. ensure no spill-overs
#define EDGESSZ_KVS (EDGESSZ / VECTOR_SIZE)

#define VERTEXPTRSSZ (KVDATA_RANGE / NUMINTSINKEYVALUETYPE)
...
#define KVSOURCEDRAMSZ (MESSAGES_AREASZ + EDGESWORKLOAD_AREASZ + VERTICESWORKLOAD_AREASZ + ACTIVEVERTICESWORKLOAD_AREASZ + WORKSPACE_AREASZ)					
...
#define BASEOFFSET_KVDRAM (BASEOFFSET_STATSDRAM + KVSTATSDRAMSZ) //
