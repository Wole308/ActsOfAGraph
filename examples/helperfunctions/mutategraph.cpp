...
void mutategraph::mutate(edge_t * vertexptrbuffer, edge2_type * edgedatabuffer, edge_t * packedvertexptrbuffer, uuint64_dt * packededgedatabuffer){				
	...
	utilityobj->printvalues("mutategraph::mutate:: vertexptrbuffer", vertexptrbuffer, 16);
	
	utilityobj->printkeyvalues("mutategraph::mutate:: counts1", counts1, 16);
	utilityobj->countvalues("mutategraph::mutate:: counts1", counts1, KVDATA_RANGE);
	
	utilityobj->printkeyvalues("mutategraph::mutate:: counts2", counts2, 16);
	utilityobj->countvalues("mutategraph::mutate:: counts2", counts2, KVDATA_RANGE);
	
	utilityobj->printpackededges("mutategraph::mutate:: packededgedatabuffer", packededgedatabuffer, 16);
	utilityobj->printvalues("mutategraph::mutate:: packedvertexptrbuffer", packedvertexptrbuffer, 16);
