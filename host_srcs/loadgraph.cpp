...
globalparams_t loadgraph::createmessages(
	...
	kvbuffer[BASEOFFSET_MESSAGESDATA_KVS + MESSAGES_THRESHOLD_HYBRIDGPMODE_MAXVTHRESHOLD_PER_VPARTITION].data[0].key = CONFIG_HYBRIDGPMODE_MAXVTHRESHOLD_PER_VPARTITION; // 0;
