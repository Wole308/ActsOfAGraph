...
public:
	...
	void printkeyvalues(string message, keyvalue_vec_bittype keyvalues[MAX_NUM_PARTITIONS][BLOCKRAM_SIZE], unsigned int numcols, unsigned int size);
	...
	void printstructuresbeforekernelrun(string message, uint512_vec_dt * kvsourcedram[NUM_PEs], unsigned int size);
	void printstructuresafterkernelrun(string message, uint512_vec_dt * kvsourcedram[NUM_PEs], unsigned int size);
	...
	void setarray(unsigned int array[NUM_PEs], unsigned int size, unsigned int value);
	...
	void clearkeyvalues(uint512_vec_dt * kvbuffer[NUM_PEs]);
