...
set Library     "hls"
set IPName      "topkernel"
set Version     "1.0"
set DisplayName "Topkernel"
set Revision    "2007272331"
set Description "An IP generated by Vivado HLS"
set Device      "virtexuplus"
set AutoFamily  ""
set Taxonomy    "/VIVADO_HLS_IP"
set target_part "xcvu9p-fsgd2104-2-i"
set target_lang "verilog"
set has_xpm_memory "0"
set sdx_kernel_name "topkernel"
set sdx_kernel_type ""
set sdx_kernel_files {}
set enable_xo_gen 0
set sdaccel_dir [file join [pwd] .. sdaccel]
set solution_dir "/home/oj2zf/Documents/ActsOfAGraph/vhls_proj/actsofagraph/solution1"
set debug_dir [file join $solution_dir .debug]
set xo_hls_files_dir ""
set hdl_module_list {collectstats00_sizes00
...
set Interfaces {
    ...
    ap_clk {
        ...
        buses "s_axi_control m_axi_gmem0 m_axi_gmem1 m_axi_gmem2"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_gmem0 {
        ...
        port_width "AWADDR 32 AWID 1 AWUSER 1 WDATA 512 WSTRB 64 WID 1 WUSER 1 ARADDR 32 ARID 1 ARUSER 1 RDATA 512 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
                Width "8"
    ...
    m_axi_gmem2 {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_gmem2"
        data_width "64"
        param_prefix "C_M_AXI_GMEM2"
...
## System Info
set user_parameters_list {clk_period 10 machine 64 combinational 0 latency 57 II x}
