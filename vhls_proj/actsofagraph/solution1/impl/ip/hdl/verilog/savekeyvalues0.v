...
reg   [0:0] icmp_ln2501_reg_176;
reg   [0:0] icmp_ln2501_reg_176_pp0_iter1_reg;
reg    kvdram_V_blk_n_B;
wire    ap_CS_fsm_state10;
reg   [9:0] i_0_reg_107;
wire   [32:0] add_ln321_fu_132_p2;
reg   [32:0] add_ln321_reg_165;
wire   [0:0] icmp_ln2501_fu_148_p2;
...
wire   [9:0] i_fu_154_p2;
reg    ap_enable_reg_pp0_iter0;
reg   [511:0] buffer_V_load_reg_190;
reg    ap_block_pp0_stage0_subdone;
reg    ap_condition_pp0_exit_iter0_state3;
reg    ap_enable_reg_pp0_iter1;
wire   [63:0] zext_ln2504_fu_160_p1;
wire   [63:0] zext_ln321_5_fu_138_p1;
wire    ap_block_pp0_stage0_01001;
wire   [31:0] add_ln2504_fu_118_p2;
wire   [32:0] zext_ln321_fu_124_p1;
wire   [32:0] zext_ln321_4_fu_128_p1;
reg   [7:0] ap_NS_fsm;
reg    ap_idle_pp0;
wire    ap_enable_pp0;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln2501_fu_148_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln2501_reg_176 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (*) begin
    if ((icmp_ln2501_fu_148_p2 == 1'd1)) begin
...
always @ (*) begin
    if ((((ap_start == 1'b0) & (1'b1 == ap_CS_fsm_state1)) | ((m_axi_kvdram_V_BVALID == 1'b1) & (1'b1 == ap_CS_fsm_state10)))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if (((icmp_ln2501_reg_176_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0))) begin
...
always @ (*) begin
    if (((icmp_ln2501_reg_176_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((ap_enable_reg_pp0_iter0 == 1'b1) & (ap_enable_reg_pp0_iter1 == 1'b0) & (1'b0 == ap_block_pp0_stage0_subdone) & (icmp_ln2501_fu_148_p2 == 1'd1)) & ~((ap_enable_reg_pp0_iter2 == 1'b1) & (ap_enable_reg_pp0_iter1 == 1'b0) & (1'b0 == ap_block_pp0_stage0_subdone)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((ap_enable_reg_pp0_iter2 == 1'b1) & (ap_enable_reg_pp0_iter1 == 1'b0) & (1'b0 == ap_block_pp0_stage0_subdone)) | ((ap_enable_reg_pp0_iter0 == 1'b1) & (ap_enable_reg_pp0_iter1 == 1'b0) & (1'b0 == ap_block_pp0_stage0_subdone) & (icmp_ln2501_fu_148_p2 == 1'd1)))) begin
...
assign add_ln2504_fu_118_p2 = (offset_kvs + 32'd35950592);

assign add_ln321_fu_132_p2 = (zext_ln321_fu_124_p1 + zext_ln321_4_fu_128_p1);
...
always @ (*) begin
    ap_block_state5_io = ((icmp_ln2501_reg_176_pp0_iter1_reg == 1'd0) & (m_axi_kvdram_V_WREADY == 1'b0));
end
...
assign buffer_V_address0 = zext_ln2504_fu_160_p1;

assign i_fu_154_p2 = (i_0_reg_107 + 10'd1);

assign icmp_ln2501_fu_148_p2 = ((i_0_reg_107 == 10'd512) ? 1'b1 : 1'b0);
...
assign m_axi_kvdram_V_AWADDR = zext_ln321_5_fu_138_p1;
...
assign m_axi_kvdram_V_AWLEN = 32'd512;
...
assign m_axi_kvdram_V_WDATA = buffer_V_load_reg_190;
...
assign zext_ln2504_fu_160_p1 = i_0_reg_107;

assign zext_ln321_4_fu_128_p1 = kvdram_V_offset;

assign zext_ln321_5_fu_138_p1 = add_ln321_reg_165;

assign zext_ln321_fu_124_p1 = add_ln2504_fu_118_p2;

endmodule //savekeyvalues0
