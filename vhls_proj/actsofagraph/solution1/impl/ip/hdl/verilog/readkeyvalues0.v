...
reg   [0:0] icmp_ln1276_reg_172;
reg   [9:0] i_0_reg_102;
reg   [9:0] i_0_reg_102_pp0_iter1_reg;
wire    ap_block_state9_pp0_stage0_iter0;
reg    ap_block_state10_pp0_stage0_iter1;
wire    ap_block_state11_pp0_stage0_iter2;
reg    ap_block_pp0_stage0_11001;
wire   [32:0] add_ln321_fu_128_p2;
reg   [32:0] add_ln321_reg_161;
wire   [0:0] icmp_ln1276_fu_144_p2;
reg   [0:0] icmp_ln1276_reg_172_pp0_iter1_reg;
wire   [9:0] i_fu_150_p2;
reg   [9:0] i_reg_176;
reg    ap_enable_reg_pp0_iter0;
reg   [511:0] kvdram_V_addr_read_reg_181;
wire    ap_CS_fsm_state8;
reg    ap_block_pp0_stage0_subdone;
reg    ap_condition_pp0_exit_iter0_state9;
reg    ap_enable_reg_pp0_iter2;
reg   [9:0] ap_phi_mux_i_0_phi_fu_106_p4;
wire   [63:0] zext_ln1279_fu_156_p1;
wire   [63:0] zext_ln321_9_fu_134_p1;
wire   [31:0] add_ln1279_fu_114_p2;
wire   [32:0] zext_ln321_fu_120_p1;
wire   [32:0] zext_ln321_8_fu_124_p1;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln1276_reg_172 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln1276_reg_172 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        kvdram_V_addr_read_reg_181 <= m_axi_kvdram_V_RDATA;
    end
end

always @ (*) begin
    if ((icmp_ln1276_fu_144_p2 == 1'd1)) begin
...
always @ (*) begin
    if (((icmp_ln1276_reg_172 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0))) begin
...
always @ (*) begin
    if (((icmp_ln1276_reg_172_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        buffer_V_we0 = 64'd18446744073709551615;
    end else begin
        buffer_V_we0 = 64'd0;
    end
end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (icmp_ln1276_fu_144_p2 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b0)) & ~((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0)) | ((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (icmp_ln1276_fu_144_p2 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b0)))) begin
...
assign add_ln1279_fu_114_p2 = (offset_kvs + 32'd35950592);

assign add_ln321_fu_128_p2 = (zext_ln321_fu_120_p1 + zext_ln321_8_fu_124_p1);
...
always @ (*) begin
    ap_block_pp0_stage0_11001 = ((icmp_ln1276_reg_172 == 1'd0) & (m_axi_kvdram_V_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((icmp_ln1276_reg_172 == 1'd0) & (m_axi_kvdram_V_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_state10_pp0_stage0_iter1 = ((icmp_ln1276_reg_172 == 1'd0) & (m_axi_kvdram_V_RVALID == 1'b0));
end
...
assign buffer_V_address0 = zext_ln1279_fu_156_p1;

assign buffer_V_d0 = kvdram_V_addr_read_reg_181;

assign i_fu_150_p2 = (ap_phi_mux_i_0_phi_fu_106_p4 + 10'd1);

assign icmp_ln1276_fu_144_p2 = ((ap_phi_mux_i_0_phi_fu_106_p4 == 10'd512) ? 1'b1 : 1'b0);

assign m_axi_kvdram_V_ARADDR = zext_ln321_9_fu_134_p1;
...
assign m_axi_kvdram_V_ARLEN = 32'd512;
...
assign zext_ln1279_fu_156_p1 = i_0_reg_102_pp0_iter1_reg;

assign zext_ln321_8_fu_124_p1 = kvdram_V_offset;

assign zext_ln321_9_fu_134_p1 = add_ln321_reg_161;

assign zext_ln321_fu_120_p1 = add_ln1279_fu_114_p2;

endmodule //readkeyvalues0
