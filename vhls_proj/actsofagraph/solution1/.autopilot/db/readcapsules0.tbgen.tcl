...
set C_modelArgList {
	...
	{ capsule0_value int 32 regular {array 32 { 0 3 } 0 1 }  }
	{ capsule1_key int 32 regular {array 32 { 0 3 } 0 1 }  }
	{ capsule1_value int 32 regular {array 32 { 0 3 } 0 1 }  }
	{ capsule2_key int 32 regular {array 32 { 0 3 } 0 1 }  }
	{ capsule2_value int 32 regular {array 32 { 0 3 } 0 1 }  }
	{ capsule3_key int 32 regular {array 32 { 0 3 } 0 1 }  }
	{ capsule3_value int 32 regular {array 32 { 0 3 } 0 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "kvdram_V", "interface" : "axi_master", "bitwidth" : 512, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "capsule0_value", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "capsule1_key", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "capsule1_value", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "capsule2_key", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "capsule2_value", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "capsule3_key", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "capsule3_value", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ offset sc_in sc_lv 24 signal 14 } 
	{ capsulemetadata_globaloffset sc_in sc_lv 32 signal 15 } 
	{ capsulemetadata_localoffset sc_in sc_lv 32 signal 16 } 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			{"Name" : "kvdram_V", "Type" : "MAXI", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_readkeyvalues0_fu_418", "Port" : "kvdram_V"}]},
			{"Name" : "kvdram_V_offset", "Type" : "None", "Direction" : "I"},
			{"Name" : "BIGcapsule0_V", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_readkeyvalues0_fu_418", "Port" : "buffer_V"}]},
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_readkeyvalues0_fu_418", "Parent" : "0",
		"CDFG" : "readkeyvalues0",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "35", "Max" : "2129"}
	, {"Name" : "Interval", "Min" : "35", "Max" : "2129"}
]}
...
set Spec2ImplPortList { 
	...
	capsule0_value { ap_memory {  { capsule0_value_address0 mem_address 1 5 }  { capsule0_value_ce0 mem_ce 1 1 }  { capsule0_value_we0 mem_we 1 1 }  { capsule0_value_d0 mem_din 1 32 } } }
	...
	capsule1_value { ap_memory {  { capsule1_value_address0 mem_address 1 5 }  { capsule1_value_ce0 mem_ce 1 1 }  { capsule1_value_we0 mem_we 1 1 }  { capsule1_value_d0 mem_din 1 32 } } }
	...
	capsule2_value { ap_memory {  { capsule2_value_address0 mem_address 1 5 }  { capsule2_value_ce0 mem_ce 1 1 }  { capsule2_value_we0 mem_we 1 1 }  { capsule2_value_d0 mem_din 1 32 } } }
	...
	capsule3_value { ap_memory {  { capsule3_value_address0 mem_address 1 5 }  { capsule3_value_ce0 mem_ce 1 1 }  { capsule3_value_we0 mem_we 1 1 }  { capsule3_value_d0 mem_din 1 32 } } }
