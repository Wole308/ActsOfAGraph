set moduleName readkeyvalues0_166
set isTopModule 0
...
set C_modelArgMapList {[ 
	{ "Name" : "kvdram_V", "interface" : "axi_master", "bitwidth" : 512, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "buffer_V", "interface" : "memory", "bitwidth" : 512, "direction" : "WRITEONLY"} , 
 	...
 	{ "Name" : "size_kvs", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ buffer_V_address0 sc_out sc_lv 9 signal 2 } 
	{ buffer_V_ce0 sc_out sc_logic 1 signal 2 } 
	{ buffer_V_we0 sc_out sc_logic 1 signal 2 } 
	{ buffer_V_d0 sc_out sc_lv 512 signal 2 } 
	{ baseaddress sc_in sc_lv 25 signal 3 } 
	{ offset_kvs sc_in sc_lv 32 signal 4 } 
	{ size_kvs sc_in sc_lv 32 signal 5 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "buffer_V_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "buffer_V", "role": "address0" }} , 
 	...
 	{ "name": "buffer_V_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":512, "type": "signal", "bundle":{"name": "buffer_V", "role": "d0" }} , 
 	...
 	{ "name": "size_kvs", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "size_kvs", "role": "default" }}  ]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "9", "Max" : "522"}
	, {"Name" : "Interval", "Min" : "9", "Max" : "522"}
]}
...
set Spec2ImplPortList { 
	...
	buffer_V { ap_memory {  { buffer_V_address0 mem_address 1 9 }  { buffer_V_ce0 mem_ce 1 1 }  { buffer_V_we0 mem_we 1 1 }  { buffer_V_d0 mem_din 1 512 } } }
	baseaddress { ap_none {  { baseaddress in_data 0 25 } } }
	offset_kvs { ap_none {  { offset_kvs in_data 0 32 } } }
	size_kvs { ap_none {  { size_kvs in_data 0 32 } } }
}
