set moduleName readkeyvalues0_157
set isTopModule 0
...
set C_modelName {readkeyvalues0.157}
set C_modelType { void 0 }
set C_modelArgList {
	{ kvdram_V int 512 regular {axi_master 0}  }
	{ kvdram_V_offset int 26 regular  }
	{ buffer_V int 512 regular {array 2112 { 0 3 } 0 1 }  }
...
set portList { 
	...
	{ buffer_V_address0 sc_out sc_lv 12 signal 2 } 
	{ buffer_V_ce0 sc_out sc_logic 1 signal 2 } 
	{ buffer_V_we0 sc_out sc_lv 64 signal 2 } 
	{ buffer_V_d0 sc_out sc_lv 512 signal 2 } 
	{ offset_kvs sc_in sc_lv 30 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "buffer_V_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":12, "type": "signal", "bundle":{"name": "buffer_V", "role": "address0" }} , 
 	{ "name": "buffer_V_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "buffer_V", "role": "ce0" }} , 
 	{ "name": "buffer_V_we0", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "buffer_V", "role": "we0" }} , 
...
set Spec2ImplPortList { 
	...
	buffer_V { ap_memory {  { buffer_V_address0 mem_address 1 12 }  { buffer_V_ce0 mem_ce 1 1 }  { buffer_V_we0 mem_we 1 64 }  { buffer_V_d0 mem_din 1 512 } } }
