...
set C_modelName {readkeyvalues0}
...
set portList { 
	...
	{ offset_kvs sc_in sc_lv 32 signal 3 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	...
	buffer_V { ap_memory {  { buffer_V_address0 mem_address 1 9 }  { buffer_V_ce0 mem_ce 1 1 }  { buffer_V_we0 mem_we 1 64 }  { buffer_V_d0 mem_din 1 512 } } }
