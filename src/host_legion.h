#ifndef HOST_LEGION_H
#define HOST_LEGION_H
...
private:
	...
	uint512_vec_dt * kvdram_dest[NUMCPUTHREADS][NUMDRAMBANKS];
	...
	cl_mem buffer_destkvdram[2][NUMDRAMBANKS];
	#endif
};
#endif
