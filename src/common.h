...
#define KVSTATS_SIZE NUMLASTLEVELPARTITIONS
...
// #define CAPSULESZ ((KVDRAMSZ / (KVBUFFER_SIZE * VECTOR_SIZE)) * NUM_PARTITIONS)
...
#define PADDEDKVSOURCEDRAMSZ (KVSOURCEDRAMSZ + 2*KVSOURCEPADDING_KVS)
