...
#define KVDATA_BATCHSIZE (1 << 26) // REMOVEME.
...
#define MINIMUMKVBUFFER_SIZE (1 << 9)
#define MINIMUMKVBUFFERSIZE_KVS (MINIMUMKVBUFFER_SIZE / VECTOR_SIZE)
#define MINIMUMSRCBUFFER_SIZE (512 - (2 * NUM_PARTITIONS)) // FIXME.
#define MAXIMUMNFACTOR 4
#define KVDRAMPADDING (((DRAMBATCHFACTOR * KVDATA_BATCHSIZE_KVS) / (MINIMUMSRCBUFFER_SIZE * MAXIMUMNFACTOR)) * (NUM_PARTITIONS * VECTOR_SIZE) * (NUM_PARTITIONS * 2))			
...
#define CAPSULESZ_KVS (((KVDRAMSZ_KVS / MINIMUMKVBUFFERSIZE_KVS) * TREE_DEPTH) * 4) // '4' is padding. FIXME.
...
#define KVSOURCEPADDING_KVS (((KVDRAMSZ_KVS / MINIMUMKVBUFFER_SIZE) * KVBUFFERPADDING) + (NUMLASTLEVELPARTITIONS * LASTLEVELPARTITIONPADDING))
