...
public:
	...
	void checkkvdrams(keyvalue_t * kvdram, metadata_t * kvstats);
	void checkkvstats(metadata_t * kvstats, unsigned int _totalnumkeyvalues);
	void printtempverticesdata(uint512_vec_dt * kvdram);
	void recordstats(metadata_t * kvstats);	
