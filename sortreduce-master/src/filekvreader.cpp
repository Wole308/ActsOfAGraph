...
template <class K, class V>
SortReduceUtils::FileKvReader<K,V>::FileKvReader(int fd, size_t moffset_bytes, size_t mfilesize_bytes) {
	this->m_offset = moffset_bytes;
	this->m_fd = fd;
	this->m_file_size = mfilesize_bytes;
	printf( "FileKvReader:: variables passed: moffset_bytes: %lu, mfilesize_bytes: %lu\n", moffset_bytes,  mfilesize_bytes );
	printf( "Loading file fd %d size %lu\n", fd,  m_file_size ); fflush(stdout);
