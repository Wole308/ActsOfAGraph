...
// kron28 
// nohup ./obj/sort 0 /localtmp/oj2zf/datasets/kronecker26/kronecker26.dat [1B]
// nohup ./obj/sort 7 /localtmp/oj2zf/datasets/kronecker30/temp_6.dat
...
int main( int argc, char** argv ) {
	...
	if ( slev == 0 ) { 
		...
		FILE* fout = fopen("/localtmp/oj2zf/datasets/kronecker26/temp_0.dat", "wb");
	...
	for (int sort_stage = init_stage; ; sort_stage++) {
		sprintf(cur_in_filename, "/localtmp/oj2zf/datasets/kronecker26/temp_%d.dat", sort_stage);
		...
		*/
		...
		sprintf(cur_out_filename, "/localtmp/oj2zf/datasets/kronecker26/temp_%d.dat", sort_stage+1);
	...
	//////////////////////////
	FILE * file_graph;
	file_graph = fopen ("/localtmp/oj2zf/datasets/kronecker26/kronecker26.graph", "w");
	if (file_graph==NULL)	{ printf("extract_vertices::extract_vertices : error : cannot find the location of input file (vertices): /localtmp/oj2zf/datasets/kronecker26/kronecker26.graph"); }
	else { printf("extract_vertices::extract_vertices : extracting vertices from /localtmp/oj2zf/datasets/kronecker26/kronecker26.graph"); }
	////////////////////////////
